...
ANDROID_URL = "https://github.com/axldsg99999-ship-it/huilaishi-app/releases/download/v12.6.2-samsung.1/huilaishi-samsung-12.6.2-r1-release.apk"
...
def make_board(web: Image.Image, android: Image.Image) -> None:
    ...
    draw.text((82, 70), "萨瓦迪卡 12.6.2 · V60 三星稳定入口", fill=INK, font=font(42, True))
    draw.text((82, 130), "中国人学泰语 · 泰国人学中文 · 双向互动", fill=MUTED, font=font(22))

    cards = [
        (70, "网页 · 三星稳定启动", "当前页直接打开", "不跳转、不新开标签、不留空白页", web, TEAL),
        (650, "SAMSUNG · 12.6.2-R1", "下载签名 APK", "下载后允许安装未知应用", android, LIME),
    ]
    ...
    board.save(OUTPUT / "萨瓦迪卡12.6.2-三星A57双码.png")


def main() -> None:
    web = save_qr(WEB_URL, "萨瓦迪卡12.6.2-网页体验二维码.png")
    android = save_qr(ANDROID_URL, "萨瓦迪卡12.6.2-三星APK二维码.png")
