...
import {createBattle} from './combat-v3.mjs';
...
export function readRun(raw){
  try{
    ...
    if(r.stage==='battle'&&r.battle){
      ...
      if(b.version!=='storybook-combat-3'){
        b.version='storybook-combat-3';b.focus=0;delete b.enemyStance;
        if(['active','prepare'].includes(b.phase)){b.phase='prepare';b.stance=null;b.promptReady=false;b.elapsed=0;}
      }
      if(!Number.isInteger(b.focus)||b.focus<0||b.focus>3)return null;
