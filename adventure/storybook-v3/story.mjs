...
function renderPrompt() {
  ...
  const calling='<span class="call-sprite" aria-hidden="true"><img class="call-rest" src="'+art.battle.callFrames[0]+'" alt=""><img class="call-live" src="'+art.battle.callFrames[1]+'" alt=""></span>';
  voice.innerHTML=btn('hear',calling+'<span>'+(guardianSpeaking?'说话中':battle.promptReady?'再听':'听一句')+'</span>','guardian-voice',
    'aria-pressed="'+guardianSpeaking+'" aria-label="'+(mediaBusy?'停止当前声音':'听兰螳说话')+'"')+
