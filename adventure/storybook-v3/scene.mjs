...
export class PierScene {
  ...
  draw() {
    ...
    if (!w || !h) return;
    c.clearRect(0, 0, w, h);
    const backdrop=this.view==='battle' ? art.battle.backdrop : ['map','route','route-end'].includes(this.view)?art.route:art.backdrop;
    ...
    const grounded=['map','battle','route','route-end'].includes(this.view);
