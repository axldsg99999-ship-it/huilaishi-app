 ...
 */
public class CourseActivity extends BridgeActivity {
    ...
    private void configureWebViewDataDirectory() {
        ...
        try {
            // Keep the isolated R2/R3 profile so upgrading does not discard
            // course localStorage, IndexedDB, or offline learning progress.
