  ...
  function wording() {
    ...
    if (isZh()) return {
      ...
      home: [
        ...
        ["同一句，直接对比五档", "在这里切换 S5—S1，句子、适用场景、沟通目标和学习示范音会一起变化。五档都能正常听读和练习。"],
    ...
    return {
      ...
      lesson: recognitionOnly ? [
        [`${current} · บทนี้ฝึกเพื่อรู้ทัน`, "คุณเลือกระดับต่ำสุด เสียงตัวละครน่ารักใช้แสดงคำเสี่ยงเท่านั้น ไม่ใช้เป็นเสียงฝึกออกเสียงและไม่ต้องพูดตาม"],
