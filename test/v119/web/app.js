...
const FEATURE_BUNDLES = Object.freeze({
  ...
  games: Object.freeze({
    styles: Object.freeze(["arcade.css", "combat-stage.css", "campus-stage.css", "campus-adventure.css", "world-atlas.css"]),
    scripts: Object.freeze(["campus-curriculum.js", "campus-story.js", "campus-adventure.js", "world-atlas.js", "world-atlas-ui.js", "arcade.js"])
  }),
  duel: Object.freeze({
...
function enterSelectedDirection(direction = pendingDirection) {
  ...
  if (safeStorage.getItem(onboardingKey(direction)) !== "1") {
    ...
    showToast(direction === "zh-th" ? "下一步：选择今天的学习目标" : "ขั้นต่อไป: เลือกเป้าหมายการเรียนวันนี้");
    return;
  }
...
function applyDirection(direction, persist = true) {
  ...
  text("#direction-intro-copy", isChineseUi
    ? "轻点一条学习路线；下一步选今天的学习目标。词库、发音与进度会按方向分别保存。"
    : "แตะเส้นทาง แล้วเลือกเป้าหมายการเรียนในขั้นถัดไป คลังคำ การออกเสียง และความคืบหน้าจะแยกบันทึกตามเส้นทาง");
  ...
  text("#main-menu-kicker", isChineseUi ? "萨瓦迪卡 · 课后俱乐部" : "สวัสดีค่ะ · ชมรมหลังเลิกเรียน");
...
function renderCampusJourney() {
  ...
  text("#home-scene-duo", isZh ? "阿澈 × 玛莉 / 放学后俱乐部" : "อาเช่อ × มะลิ / ชมรมหลังเลิกเรียน");
...
function renderRegisterHome() {
  ...
  text("#main-menu-title", isZh ? "放学后，世界见。" : "เลิกเรียนแล้ว ไปเจอโลกกัน");
  text("#main-menu-subtitle", isZh ? "和搭档一起，把语言变成冒险的本领。" : "ออกเดินทางกับคู่หู ให้ภาษาเป็นพลังผจญภัย");
  renderCampusJourney();
