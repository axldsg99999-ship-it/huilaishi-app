(() => {
  ...
  const ui = () => isThaiUi() ? {
    ...
    wifi: "รุ่นทดลองนี้มีเสียงคำศัพท์ L1 ภาษาละ 500 คำ ยังไม่มีเสียงประโยคตัวอย่างครบทุกระดับ",
    ...
    title: "分级学习示范声包", summary: "标准语速与慢速词汇示范 · 可按等级离线安装", action: "管理",
    ...
    wifi: "本次试玩提供中泰双向 L1 单词示范音，每个方向 500 条；不包含完整六级例句音频。",
