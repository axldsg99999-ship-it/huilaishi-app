...
const OFFLINE_CACHE_VERSION = "huilaishi-offline-v118";
...
const FEATURE_BUNDLES = Object.freeze({
  ...
  games: Object.freeze({
    styles: Object.freeze(["arcade.css", "combat-stage.css", "campus-stage.css", "campus-adventure.css", "world-atlas.css", "rogue-expedition.css", "expedition-polish.css", "combat-controls.css"]),
    scripts: Object.freeze(["campus-curriculum.js", "campus-story.js", "campus-adventure.js", "world-atlas.js", "world-atlas-ui.js", "expedition-themes.js", "expedition-presentation.js", "rogue-world-content.js", "rogue-expedition.js", "rogue-expedition-ui.js", "arcade.js"])
  }),
  duel: Object.freeze({
...
function renderHubAdventure() {
  ...
  text("#hub-collection-label", zh ? "成长手记" : "บันทึกเติบโต");
...
function applyDirection(direction, persist = true) {
  ...
  const menuCopy = isChineseUi
    ? [["先听一遍", "3 句 · 约 3 分钟"], ["词汇发音", "3000 张训练卡"], ["情景对话", "8 场景 · 可离线"], ["打怪对战", "14 玩法 · 可双人"]]
  ...
  const compactNav = isChineseUi
    ? { home: "世界", live: "练习", battle: "战斗", profile: "成长" }
    : { home: "โลก", live: "ฝึก", battle: "ต่อสู้", profile: "เติบโต" };
...
async function openCampusJourney() {
  ...
  try {
    ...
    if (currentDirection !== requestedDirection || !$("#view-home").classList.contains("active") || $("#main-app").classList.contains("hidden")) return;
    navigate("battle");
    if (ready) window.ArcadeUI?.openStoryChapter?.(1);
  } finally {
