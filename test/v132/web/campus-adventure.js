...
(function () {
  ...
  const journeys = freeze({
    "zh-th": {
      ...
      intro: "醒来时，CHANINDA 已在世界另一边。她的回声藏在河畔校园的声页里；听懂它们，就能借来她的力量。",
      quest: "找回六张声页，点亮通往她的河畔舞台。",
      restored: "河畔舞台亮了。跨过两座城，你终于听见 CHANINDA 的第一声回应。",
    ...
    "th-zh": {
      ...
      intro: "เมื่อตื่นขึ้น เสี่ยวอ้ายอยู่โลกอีกฟาก เสียงสะท้อนของเขาซ่อนในหน้ากระดาษรอบมหาวิทยาลัย ฟังให้เข้าใจแล้วพลังของเขาจะช่วยคุณได้",
      quest: "ตามหาหน้ากระดาษเสียงหกแผ่น แล้วเปิดเวทีที่เชื่อมถึงเขา",
      restored: "เวทีริมคลองสว่างแล้ว ในที่สุด CHANINDA ได้ยินคำตอบแรกจากเสี่ยวอ้าย",
