const sharedColors = [
  ...
  { color: "#ff9f2f", soft: "#fff0d9", ink: "#3f2608", safe: 72, safeColor: "#37a66f" },
  { color: "#ef6461", soft: "#fff0ec", ink: "#fff", safe: 86, safeColor: "#37a66f" }
];
...
const product = {
  "zh-th": {
    ...
    setup: {
      tag: "泰语语境训练场 · BETA",
      eyebrow: "先选目标 · 随时可换",
      title: "今天先从<br><em>哪种场景开始？</em>",
      lede: "先按学习目标进入，默认推荐自然日常。<br>想精细比较时，再展开全部五档。",
      signA: "พูดให้เป็น",
      signB: "曼谷 · 01",
      picker: "当前场景语气",
      start: "就这样，开口闯关",
    ...
    modes: [
      {
        code: "S5", short: "正式", name: "正式得体", desc: "正式 · 长辈 · 客户", risk: "可听可说",
      ...
      {
        code: "S4", short: "日常", name: "自然日常", desc: "自然礼貌 · 万能开局", risk: "默认练习",
      ...
      {
        code: "S3", short: "熟人", name: "熟人随口", desc: "朋友 · 同学 · 松弛口语", risk: "限熟人",
        target: "เอาน้ำเปล่าขวดนึงนะ", roman: "ao náam-plàao khùat nʉng ná", meaning: "来瓶水哈。",
        contexts: [["朋友 ✓",0],["熟店员 △",0],["长辈 ✕",1]], reaction: "熟人才自然", face: "◡"
      },
      {
        code: "S2", short: "直接", name: "直接表达", desc: "明确 · 简短 · 设界限", risk: "按场景使用",
        target: "ขอน้ำหนึ่งขวดตอนนี้ค่ะ", roman: "kho nam nueng khuat ton ni kha", meaning: "现在请给我一瓶水。",
        contexts: [["时间紧 ✓",0],["明确需求 ✓",0],["普通日常 △",0]], reaction: "重点清楚，没有攻击性", face: "⌐"
      },
      {
        code: "S1", short: "降级", name: "冲突降级", desc: "稳住局面 · 明确边界 · 安全退出", risk: "安全练习",
        target: "เราหยุดก่อน แล้วค่อยคุยกันนะคะ", roman: "rao yut kon, laeo khoi khui kan na kha", meaning: "我们先暂停，冷静后再谈。",
        contexts: [["争论升级 ✓",0],["设定边界 ✓",0],["安全退出 ✓",0]], reaction: "局面稳住了，可以继续沟通", face: "◇"
      }
    ],
    ui: {
      weather: "今日泰语", greeting: "今天，去认识更大的世界。", avatar: "泰",
      ...
      vibeEyebrow: "王牌玩法", vibeHeading: "一句五说", vibeInfo: "只评价说法", currentMode: "当前场景语气", intent: "你想说：“请给我一瓶水”", reaction: "店员反应", consoleSafe: "适用更广", consoleTitle: "场景语气调音台", consoleRisk: "情境更强",
      ...
      battleEyebrow: "开口游戏场", battleTitle: "挑个玩法，马上开练", battleSubtitle: "单人闯关练准和快，双人抢麦比谁先说对；规则先说明，计时再开始。", battleHeroMeta: "136 怪 · 主线 + 百怪巡游", battleHeroCta: "打开双地图声斗赛", battleHeroSigil: "声", battleBadge: "每日一题", personLabel: "场景", leagueLabel: "本机最佳", leagueValue: "还没有战绩",
      passTitle: "双人对战 · 4 种玩法", passCopy: "开口格斗、均衡、闪电、语气擂台；说对就攻击",
      libraryEyebrow: "已收录 40+ 句", libraryTitle: "场景话术库", librarySubtitle: "先选关系和场合，再选择合适的场景语气。", filters: ["全部","日常","旅行","职场","朋友","边界"],
      profileName: "阿泰同学", levelLabel: "学习段位：", level: "尚未测评", modePrefix: "常用场景语气 · ", abilityTitle: "真实练习记录", abilityWeek: "本机累计 0 次", achievements: ["完成路线","有效练习","掌握词汇"],
      switchDirection: "切换学习方向", changeMode: "切换场景语气", method: "场景语气怎么选", methodAction: "查看", prototype: "内容审核 · 自动校验已通过 · 母语终审待完成",
      nav: ["学习","对话","游戏","词库","我的"],
      missionFlowAria: "本课流程", missionFlow: ["先听懂","选分寸","开口说"], missionStart: "开始练 3 句",
      modeEyebrow: "场景语气", modeTitle: "今天想练哪种说法？", modeNote: "每条路线都只练不伤人的表达；根据关系和场合选择即可。", confirmMode: "使用这个场景语气",
      ...
      infoEyebrow: "设计原则", infoTitle: "场景语气怎么选？", infoConfirm: "明白了"
    },
    warning: {
      title: "S1 冲突降级练习",
      copy: "这里全部是<strong>可安全使用的回应</strong>：先暂停、再说明边界，必要时离开或求助。",
      label: "练习重点", words: "暂停 · 边界 · 离开", note: "不刺激对方，也不牺牲自己的安全",
      accept: "开始练习", decline: "暂时不练"
    },
    principles: [
      ["是场景语气，不是人格","同一句话对老板和对死党，本来就不该一样。"],
      ["直接也能尊重人","说清需求和边界，不靠挖苦、贬低或刺激对方。"],
    ...
    phrases: [
      ...
      { level: 2, category: "social", label: "直接 · 边界", target: "ขอพูดให้จบก่อนนะ", roman: "khɔ̌ɔ phûut hâi jòp kɔ̀ɔn ná", meaning: "请先让我说完。" },
      { level: 1, category: "social", label: "冲突 · 暂停", target: "เราหยุดก่อน แล้วค่อยคุยกันนะคะ", roman: "rao yut kon, laeo khoi khui kan na kha", meaning: "我们先暂停，冷静后再谈。" },
    ...
    lessons: [
      ...
      },
      {
        ...
        answers: [{ text: "ขอน้ำเปล่าหนึ่งขวดครับ", sub: "请给我一瓶水。", correct: true, target: true },{ text: "ขอน้ำเปล่าสองขวดครับ", sub: "请给我两瓶水。（数量不对）", correct: false, target: true },{ text: "น้ำอยู่ไหน", sub: "水在哪里？", correct: false, target: true }],
  ...
  "th-zh": {
    ...
    setup: {
      ...
      eyebrow: "เลือกเป้าหมายก่อน · เปลี่ยนได้เสมอ",
      title: "วันนี้อยากเริ่มจาก<br><em>สถานการณ์แบบไหน?</em>",
      lede: "เริ่มจากเป้าหมายการเรียน โดยแนะนำภาษาสุภาพในชีวิตประจำวัน<br>หากต้องการเปรียบเทียบละเอียด ค่อยเปิดดูครบทั้ง 5 ระดับ",
      signA: "中文要会说",
      signB: "上海 · 01",
      picker: "ระดับภาษาตามสถานการณ์",
    ...
    modes: [
      ...
      {
        code: "S2", short: "พูดตรง", name: "พูดตรงให้ชัด", desc: "ชัดเจน · กระชับ · ตั้งขอบเขต", risk: "เลือกตามสถานการณ์",
        target: "现在请给我一瓶水。", roman: "Xiànzài qǐng gěi wǒ yì píng shuǐ.", meaning: "ตอนนี้ขอน้ำหนึ่งขวดค่ะ",
        contexts: [["เวลาเร่งด่วน ✓",0],["บอกความต้องการ ✓",0],["ชีวิตประจำวัน △",0]], reaction: "ประเด็นชัดและไม่โจมตีใคร", face: "⌐"
      },
      {
        code: "S1", short: "คลี่คลาย", name: "คลี่คลายความขัดแย้ง", desc: "ตั้งสติ · ตั้งขอบเขต · ถอนตัว", risk: "ฝึกได้อย่างปลอดภัย",
        target: "我们先暂停，冷静后再谈。", roman: "Wǒmen xiān zàntíng, lěngjìng hòu zài tán.", meaning: "เราหยุดก่อน แล้วค่อยคุยกันเมื่อใจเย็น",
        contexts: [["การโต้เถียงรุนแรงขึ้น ✓",0],["ตั้งขอบเขต ✓",0],["ถอนตัวอย่างปลอดภัย ✓",0]], reaction: "สถานการณ์สงบลงและคุยต่อได้", face: "◇"
      }
    ],
    ui: {
      ...
      vibeEyebrow: "โหมดเด็ด", vibeHeading: "ประโยคเดียว 5 สไตล์", vibeInfo: "ประเมินแค่สำนวน", currentMode: "โทนปัจจุบัน", intent: "คุณอยากพูดว่า “ขอน้ำหนึ่งขวด”", reaction: "ปฏิกิริยาของพนักงาน", consoleSafe: "ใช้ได้กว้าง", consoleTitle: "ตัวปรับระดับภาษา", consoleRisk: "เฉพาะสถานการณ์",
      ...
      battleEyebrow: "สนามเกมฝึกพูด", battleTitle: "เลือกเกม แล้วเริ่มได้เลย", battleSubtitle: "โหมดเดี่ยวฝึกทั้งความแม่นและความไว โหมดสองคนแข่งว่าใครพูดถูกก่อน โดยอ่านกติกาก่อนเริ่มจับเวลา", battleHeroMeta: "136 ตัว · เนื้อเรื่อง + ทัวร์ร้อยตัว", battleHeroCta: "เปิดศึกเสียงสองแผนที่", battleHeroSigil: "ล่า", battleBadge: "โจทย์ประจำวัน", personLabel: "สถานการณ์", leagueLabel: "สถิติดีที่สุดในเครื่อง", leagueValue: "ยังไม่มีสถิติ",
      passTitle: "ดวลสองคน · 4 รูปแบบ", passCopy: "ดวลพูด สมดุล สายฟ้า และระดับภาษา พูดถูกแล้วโจมตี",
      libraryEyebrow: "รวมแล้ว 40+ ประโยค", libraryTitle: "คลังประโยคตามโทน", librarySubtitle: "เลือกสถานการณ์ก่อน แล้วค่อยเลือกระดับภาษา", filters: ["ทั้งหมด","ชีวิตประจำวัน","ท่องเที่ยว","ที่ทำงาน","เพื่อน","ขอบเขต"],
      profileName: "Mint", levelLabel: "ระดับการเรียน：", level: "ยังไม่ได้ประเมิน", modePrefix: "ระดับภาษาที่ใช้บ่อย · ", abilityTitle: "บันทึกการฝึกจริง", abilityWeek: "สะสมในเครื่อง 0 ครั้ง", achievements: ["เส้นทางที่จบ","การฝึกที่ทำ","คำที่จำได้"],
      switchDirection: "สลับเส้นทางการเรียน", changeMode: "เปลี่ยนระดับภาษาตามสถานการณ์", method: "วิธีเลือกระดับภาษาตามสถานการณ์", methodAction: "ดู", prototype: "ตรวจอัตโนมัติแล้ว · รอเจ้าของภาษาตรวจรอบสุดท้าย",
      ...
      modeEyebrow: "ระดับภาษาตามสถานการณ์", modeTitle: "วันนี้อยากฝึกวิธีพูดแบบไหน?", modeNote: "ทุกเส้นทางใช้เฉพาะภาษาที่ไม่ทำร้ายผู้อื่น เลือกตามความสัมพันธ์และสถานการณ์", confirmMode: "ใช้ระดับนี้",
      ...
      modeToast: "เปลี่ยนระดับภาษาตามสถานการณ์เป็น",
      ...
      infoEyebrow: "หลักการออกแบบ", infoTitle: "เลือกระดับภาษาให้เหมาะกับสถานการณ์อย่างไร?", infoConfirm: "เข้าใจแล้ว"
    },
    warning: {
      title: "S1 ฝึกคลี่คลายความขัดแย้ง",
      copy: "ทุกประโยคเป็น<strong>คำตอบที่ใช้ได้อย่างปลอดภัย</strong>: หยุดก่อน บอกขอบเขต แล้วถอนตัวหรือขอความช่วยเหลือเมื่อจำเป็น",
      label: "จุดฝึก", words: "หยุด · ขอบเขต · ถอนตัว", note: "ไม่ยั่วยุอีกฝ่ายและให้ความสำคัญกับความปลอดภัย",
      accept: "เริ่มฝึก", decline: "ไว้ฝึกทีหลัง"
    },
    principles: [
      ["เป็นระดับภาษา ไม่ใช่นิสัย","ประโยคเดียวกันไม่ควรพูดกับเจ้านายและเพื่อนสนิทแบบเดียวกัน"],
      ["พูดตรงได้โดยยังให้เกียรติ","บอกความต้องการและขอบเขตให้ชัด โดยไม่ประชด ดูถูก หรือยั่วยุอีกฝ่าย"],
    ...
    phrases: [
      ...
      { level: 2, category: "social", label: "พูดตรง · ตั้งขอบเขต", target: "请先让我把话说完。", roman: "Qǐng xiān ràng wǒ bǎ huà shuō wán.", meaning: "กรุณาให้ฉันพูดให้จบก่อน" },
      { level: 1, category: "social", label: "ขัดแย้ง · หยุดก่อน", target: "我们先暂停，冷静后再谈。", roman: "Wǒmen xiān zàntíng, lěngjìng hòu zài tán.", meaning: "เราหยุดก่อน แล้วค่อยคุยกันเมื่อใจเย็น" },
    ...
    lessons: [
      ...
      },
      {
        ...
        answers: [{ text: "麻烦给我拿一瓶水，谢谢。", sub: "Máfan gěi wǒ ná yì píng shuǐ, xièxie.", correct: true, target: true },{ text: "矿泉水在哪里？", sub: "Kuàngquánshuǐ zài nǎli?", correct: false, target: true },{ text: "麻烦给我拿两瓶水，谢谢。", sub: "Máfan gěi wǒ ná liǎng píng shuǐ, xièxie. — จำนวนไม่ตรง", correct: false, target: true }],
      ...
      },
      {
        ...
        answers: [{ text: "不用了，谢谢。", sub: "Bú yòng le, xièxie.", correct: true, target: true },{ text: "我有袋子。", sub: "Wǒ yǒu dàizi. — ความหมายไม่ตรง", correct: false, target: true },{ text: "没有袋子。", sub: "Méiyǒu dàizi. — ความหมายไม่ตรง", correct: false, target: true }],
...
const ONBOARDING_GOAL_MODES = Object.freeze({ daily: 1, friends: 2, recognize: 4 });
...
const OFFLINE_CACHE_VERSION = "huilaishi-offline-v131";
...
const FEATURE_BUNDLES = Object.freeze({
  ...
  games: Object.freeze({
    styles: Object.freeze(["arcade.css", "combat-stage.css", "campus-stage.css", "campus-adventure.css", "world-atlas.css", "rogue-expedition.css", "expedition-polish.css", "combat-controls.css", "thought-battle.css"]),
    scripts: Object.freeze(["campus-curriculum.js", "campus-story.js", "campus-adventure.js", "world-atlas.js", "world-atlas-ui.js", "expedition-themes.js", "expedition-presentation.js", "rogue-world-content.js", "rogue-expedition.js", "rogue-expedition-ui.js", "thought-battle.js", "arcade.js"])
  }),
  duel: Object.freeze({
    styles: Object.freeze(["battle.css"]),
    scripts: Object.freeze(["battle-records.js", "battle.js"])
  })
});
...
async function featureBundleReachable(name) {
  ...
  // On a normal online visit, the stylesheet/script load itself is the probe.
  // Fetching every large module first doubled the transfer and could leave the
  // game hall on a loading skeleton for close to a minute on mobile networks.
...
function runtimeFeatureControls(view) {
  return view === "battle"
    ? [$("#battle-vision-cta"), $("#pass-phone"), $("#arcade-expand"), $("#arcade-review-learning")]
    : [$("#start-vocab-quiz")];
}
...
function renderFeatureAvailability(view, ready) {
  ...
  runtimeFeatureControls(view).forEach(control => { if (control) control.disabled = !ready; });
  if (ready) return;
  if (view === "battle" && $("#arcade-grid")) $("#arcade-grid").innerHTML = "";
  if (view === "library" && $("#vocab-list")) $("#vocab-list").innerHTML = "";
...
function runtimeStyleUrl(path) {
  const url = new URL(path, document.baseURI);
  // Vite treats a CSS file requested by a dynamically-created <link> as a JS
  // module unless its direct flag is present. Static hosting and native shells
  // keep the unmodified URL, so their file/offline lookup stays unchanged.
...
function loadRuntimeStyle(path) {
  ...
  const href = runtimeStyleUrl(path);
...
function featureBundleReady(name) {
  ...
  if (name === "games") return Boolean(window.ArcadeUI);
  if (name === "duel") return Boolean(window.HUILAISHI_LOCAL_BATTLE);
  return false;
}

function gameVocabSeedPath() {
  let level = 1;
  try { level = Number(globalThis.HUILAISHI_STORAGE?.getItem(`huilaishi-vocab-level-${currentDirection}`)) || 1; } catch (_) {}
  if (level <= 2) return "vocab-l1-l2.js";
  if (level <= 4) return "vocab-l3-l4.js";
  return "vocab-l5-l6.js";
}

function refreshThaiPhoneticMetadata() {
  const phonetic = window.HUILAISHI_THAI_PHONETIC;
  if (!phonetic?.enrichAll) return null;
  const stats = phonetic.enrichAll();
  phonetic.stats = stats;
  return stats;
}

async function ensureGameVocabSeed() {
  const path = gameVocabSeedPath();
  const ready = path === "vocab-l1-l2.js" ? window.HUILAISHI_VOCAB_L12
    : path === "vocab-l3-l4.js" ? window.HUILAISHI_VOCAB_L34
      : window.HUILAISHI_VOCAB_L56;
  if (ready) {
    refreshThaiPhoneticMetadata();
    return true;
  }
...
async function ensureFeatureBundle(name) {
  ...
  const job = (async () => {
    ...
    if (name === "games") await ensureGameVocabSeed();
    if (name === "duel") await ensureFeatureBundle("vocab");
    const bundle = FEATURE_BUNDLES[name];
    await Promise.all(bundle.styles.map(loadRuntimeStyle));
    if (name === "vocab") {
      const dataScripts = bundle.scripts.filter(path => path !== "vocab-ui.js");
      await Promise.all(dataScripts.map(loadRuntimeScript));
      if (internalReviewAssetsRequested()) await loadRuntimeScript("vocab-review-candidates.js");
      // Thai phonetic metadata is initialized before the 3000-word inventory.
      // Re-run enrichment after lazy data arrives so near-sounds, tones, and
      // example quality flags are available to both the library and games.
      refreshThaiPhoneticMetadata();
      await loadRuntimeScript("vocab-ui.js");
    } else {
      for (const path of bundle.scripts) await loadRuntimeScript(path);
    }
    ...
    if (name === "vocab") {
      ...
      // The first playable screen only needs the current level seed. Complete
      // 3000-word progress and review data hydrate quietly after the hall is
      // interactive, then the learning bridge refreshes in place.
      void ensureFeatureBundle("vocab")
        .then(() => window.ArcadeUI?.render?.())
        .catch(() => {});
    }
...
async function prepareViewFeatures(view) {
  ...
  runtimeFeatureControls(view).forEach(control => { if (control) control.disabled = true; });
  try {
...
const HUILAISHI_LOCAL_DATA_EXACT_KEYS = Object.freeze([
  ...
  "huilaishi-campus-music-v1",
  "huilaishi-wardrobe-v125",
  "xulong-campus-rewards-v1",
  "huilaishi-opening-comic-v126",
...
const HUILAISHI_LOCAL_DATA_PREFIXES = Object.freeze([
  ...
  "huilaishi-monster-progress-",
  "huilaishi-monster-rally-progress-",
  "huilaishi-monster-expedition-",
  "huilaishi-campus-notebook-",
  "huilaishi-world-postcards-",
  "huilaishi-world-journey-v1-",
  "huilaishi-rogue-v1-",
  "huilaishi-entry-guide-v1-",
  "huilaishi-guide-v12:",
...
function onboardingGoalForMode(index = pendingMode) {
  return Object.keys(ONBOARDING_GOAL_MODES).find(goal => ONBOARDING_GOAL_MODES[goal] === Number(index)) || "";
}

function isSetupSelectionSource(source = "sheet") {
  return String(source).startsWith("setup");
}

function registerPracticePolicy(index) {
  const zh = currentDirection === "zh-th";
  return (zh
    ? ["正式场合", "默认练习", "限熟人", "直接边界", "冲突降级"]
    : ["สถานการณ์ทางการ", "ค่าเริ่มต้น", "ใช้กับคนสนิท", "ตั้งขอบเขตตรง", "คลี่คลายความขัดแย้ง"]
...
function enterSelectedDirection(direction = pendingDirection) {
  ...
  if (safeStorage.getItem(onboardingKey(direction)) !== "1") {
    showOnboarding({ history: "replace" });
    return;
  }
...
function showDirection(options = {}) {
  ...
  const savedDirection = safeStorage.getItem("learningDirection");
  const hasSavedDirection = Boolean(product[savedDirection]);
  const hasCompletedRoute = hasSavedDirection && safeStorage.getItem(onboardingKey(savedDirection)) === "1";
  $("#close-direction").classList.toggle("hidden", !hasCompletedRoute);
  if (hasSavedDirection) {
    pendingDirection = savedDirection;
    ...
    text("#direction-cta", currentDirection === "zh-th" ? "请选择学习方向" : "เลือกเส้นทางการเรียน");
  }
  rememberAppRoute("direction", options.history || "push");
  revealEntryArtwork();
  window.XULONG_COMIC?.maybe({storage:safeStorage,locale:currentDirection==='th-zh'?'th':'zh'});
}

function revealEntryArtwork() {
  // Defer decode until the shell is painted. Never hold up direction buttons.
  requestAnimationFrame(() => requestAnimationFrame(() => {
    if (window.HUILAISHI_NATIVE_LIGHTWEIGHT) return;
    document.querySelectorAll('[data-entry-art]').forEach(image => {
      if (!image.getAttribute('src')) image.src = image.dataset.entryArt;
    });
    document.querySelector('.entry-scene')?.setAttribute('data-art-ready', 'true');
  }));
}

function showWelcome() {
  const zh = currentDirection === "zh-th";
  $("#welcome-step").classList.remove("hidden");
  $("#onboarding").classList.add("welcome-visible");
  $("#onboarding").setAttribute("aria-labelledby", "welcome-title");
  text("#welcome-edition", zh ? "序章 / 01" : "บทนำ / 01");
  text("#welcome-place", zh ? "莲潮港 · 失散的声音" : "เมืองสะพานหมึก · เสียงที่พลัดพราก");
  text("#welcome-name", zh ? "CHANINDA · 留言" : "小艾 · ข้อความที่ฝากไว้");
  text("#welcome-eyebrow", zh ? "折声界 · 恋人的回声" : "โลกเสียงพับ · เสียงของคนรัก");
  text("#welcome-title", zh ? "她的声音，在世界另一边。" : "เสียงของเขาอยู่อีกโลกหนึ่ง");
  text("#welcome-copy", zh ? "小艾和 CHANINDA 被失语风暴分开。你将跟随小艾，学会泰语，把散落的留言变成通往她的言术。" : "พายุไร้ภาษาแยก CHANINDA กับ小艾 คุณจะติดตาม CHANINDA เรียนภาษาจีน และเปลี่ยนข้อความที่กระจัดกระจายเป็นวิชาถ้อยคำเพื่อตามหาเขา");
  text("#welcome-step-learn", zh ? "听见声音" : "ฟังเสียง");
  text("#welcome-step-play", zh ? "寻找线索" : "หาเบาะแส");
  text("#welcome-step-relic", zh ? "寄出回信" : "ส่งจดหมาย");
  $(".welcome-steps").setAttribute("aria-label", zh ? "新手路线" : "เส้นทางเริ่มต้น");
  $("#welcome-back").setAttribute("aria-label", zh ? "返回选择语言" : "กลับไปเลือกภาษา");
  text("#welcome-start-label", zh ? "寻找她的第一张声页" : "ตามหาหน้ากระดาษแรกของเขา");
  text("#welcome-note", zh ? "先用点选玩，不需要开启麦克风。" : "เริ่มด้วยการแตะเลือก ยังไม่ต้องเปิดไมโครโฟน");
  text("#welcome-skip", zh ? "跳过引导，先逛逛" : "ข้ามคำแนะนำ ไปสำรวจก่อน");
  text("#welcome-status", "");
  const companion = $("#welcome-companion");
  if (!window.HUILAISHI_NATIVE_LIGHTWEIGHT) companion.src = window.HUILAISHI_ENTRY_ART?.[zh ? "thai" : "chinese"] || `assets/game/hero-${zh ? "thai" : "chinese"}-v116-idle.webp`;
  requestAnimationFrame(() => $("#welcome-title").focus({preventScroll:true}));
}

function skipWelcome() {
  safeStorage.setItem(onboardingKey(), "1");
  navigate("home", { history: "root" });
}

async function startWelcomeAdventure() {
  const button = $("#welcome-start");
  if (button.disabled) return;
  button.disabled = true;
  button.setAttribute("aria-busy", "true");
  text("#welcome-status", currentDirection === "zh-th" ? "正在准备第一场；你也可以先逛逛。" : "กำลังเตรียมฉากแรก หรือข้ามไปสำรวจก่อนได้");
  const requestedDirection = currentDirection;
  try {
    const ready = Boolean(window.XULONG_WORLD_UI);
    if (currentDirection !== requestedDirection || $("#welcome-step").classList.contains("hidden") || $("#onboarding").classList.contains("hidden")) return;
    if (!ready) { text("#welcome-status", currentDirection === "zh-th" ? "场景暂未载入，请重试或先逛逛。" : "ยังโหลดฉากไม่ได้ ลองใหม่หรือไปสำรวจก่อน"); return; }
    skipWelcome();
    window.XULONG_WORLD_UI.start();
...
function renderHubAdventure() {
  const zh = currentDirection === "zh-th";
  const saved = readProgressJson(`huilaishi-rogue-v1-${currentDirection}`, null);
  const run = saved?.run;
  const ongoing = run && !["won", "lost"].includes(run.phase) && Number.isInteger(run.floor) && run.floor >= 0 && run.floor < 9;
  text("#hub-adventure-title", ongoing ? (zh ? "继续冒险" : "ผจญภัยต่อ") : (zh ? "开始冒险" : "เริ่มผจญภัย"));
  text("#hub-adventure-note", ongoing
    ? (zh ? `双城远征 · 第 ${run.floor + 1}/9 站 · ${run.relics?.length || 0} 件强化` : `ผจญภัยสองเมือง · จุดที่ ${run.floor + 1}/9 · พลังเสริม ${run.relics?.length || 0}`)
    : (zh ? "双城远征 · 学会词语，找回声页" : "ผจญภัยสองเมือง · เรียนคำ ตามหาหน้ากระดาษ"));
  text("#hub-story-label", zh ? "剧情地图" : "แผนที่เรื่องราว");
  text("#hub-story-note", zh ? "双城故事" : "เรื่องราวสองเมือง");
  text("#hub-study-label", zh ? "直接学习" : "ฝึกภาษา");
  text("#hub-study-note", zh ? "听说与词汇" : "เสียงและคำศัพท์");
  text("#hub-collection-label", zh ? "旅行记录" : "บันทึกเดินทาง");
  text("#hub-collection-note", zh ? "本机记录" : "ข้อมูลในเครื่อง");
  text("#hub-replay", zh ? "重玩新手演练（不改远征存档）" : "เล่นบทฝึกอีกครั้ง (ไม่เปลี่ยนเซฟผจญภัย)");
  $("#hub-lover-letter")?.classList.toggle("hidden", safeStorage.getItem(`huilaishi-entry-guide-v1-${currentDirection}`)!=="done");
  text("#hub-letter-title", zh ? "收到的声页 · CHANINDA 的第一封信" : "หน้ากระดาษที่ได้รับ · จดหมายฉบับแรกจาก 小艾");
  text("#hub-letter-body", zh ? "「小艾，我也在找你。这里的人说中文，我会学会它。等我们再见面，就没有听不懂的话了。」" : "“CHANINDA ฉันก็กำลังตามหาเธอ คนที่นี่พูดภาษาไทย ฉันจะเรียนรู้มัน เมื่อเราพบกันอีก เราจะเข้าใจกันมากขึ้น”");
  $("#hub-shortcuts").setAttribute("aria-label", zh ? "冒险与学习" : "ผจญภัยและฝึกภาษา");
}

async function openHubAdventure(rehearsal = false) {
  const button = $("#hub-adventure"), requestedDirection = currentDirection;
  if (button.disabled) return;
  button.disabled = true; button.setAttribute("aria-busy", "true");
  try {
    const ready = await prepareViewFeatures("battle");
    if (currentDirection !== requestedDirection || !$("#view-home").classList.contains("active") || $("#main-app").classList.contains("hidden")) return;
    if (!ready) return;
    navigate("battle");
    await window.ArcadeUI?.openRogue?.({ guided: rehearsal, rehearsal, direct: true, onGuideDone: returnToHub });
  } finally { button.disabled = false; button.removeAttribute("aria-busy"); renderHubAdventure(); }
}

function setOnboardingStage(stage, focus = true, historyMode = "push") {
  $("#welcome-step").classList.add("hidden");
  $("#onboarding").classList.remove("welcome-visible");
  ...
  text("#setup-tag", currentDirection === "zh-th"
    ? (selecting ? "选择学习目标" : "确认学习路线")
    : (selecting ? "เลือกเป้าหมายการเรียน" : "ยืนยันเส้นทางการเรียน"));
  ...
  requestAnimationFrame(() => {
    ...
    const goal = onboardingGoalForMode(pendingMode);
    const target = selecting
      ? (goal ? $(`[data-onboarding-goal="${goal}"]`) : $("#setup-all-levels summary"))
...
function showOnboarding(options = {}) {
  ...
  if ($("#setup-all-levels")) $("#setup-all-levels").open = !onboardingGoalForMode(pendingMode);
  renderModeList();
  updateOnboardingPreviewAction();
  setOnboardingStage("select", false, options.history || "push");
  if (onboardingIsFirstRun) showWelcome();
...
function renderLocalProgress() {
  ...
  const gameIds = ["voice", "monster", "match", "audio", "speed", "tone", "polish", "grade-lock", "scene-listen", "register-shift", "memory", "survival", "bingo", "reflex"];
  ...
  text("#profile-level", currentDirection === "zh-th" ? "学习记录" : "บันทึกการเรียน");
  text(".profile-avatar em", "");
  ...
  const firstAction = $("#profile-first-action");
  firstAction?.classList.toggle("hidden", !isFreshProfile);
  if (isFreshProfile) {
    text("#profile-first-action-title", currentDirection === "zh-th" ? "完成第一次真实练习" : "ทำแบบฝึกจริงครั้งแรก");
    text("#profile-first-action-copy", currentDirection === "zh-th" ? "先听、选对场合，再开口说一句" : "ฟังก่อน เลือกให้เหมาะกับสถานการณ์ แล้วพูดหนึ่งประโยค");
    text("#profile-first-action-cta", currentDirection === "zh-th" ? "开始 3 分钟任务" : "เริ่มภารกิจ 3 นาที");
  }
  ...
  if (chart) {
    ...
    chart.setAttribute("aria-label", currentDirection === "zh-th"
      ? `十四种游戏的本机最佳分：${gameBest.join("、")}`
      : `คะแนนดีที่สุดของเกมทั้ง 14 แบบในเครื่อง: ${gameBest.join(", ")}`);
  }
}
...
function renderAboutDisclosure() {
  ...
  const standaloneFile = Boolean(window.HUILAISHI_NATIVE_IOS) || Boolean(window.SINGLE_FILE_BUILD) || location.protocol === "file:";
  ...
  text("#about-single-file-note", isZh
    ? "当前是 iPhone / iPad 离线安装版；关键披露已完整写在本页，联网政策文档入口已隐藏。"
    : "ขณะนี้เป็นแอป iPhone / iPad แบบออฟไลน์ คำชี้แจงสำคัญอยู่ในหน้านี้ครบแล้ว และซ่อนลิงก์เอกสารออนไลน์ไว้");
}
...
function renderLocalDataManagementUi() {
  ...
  text("#data-clear-scope span", isZh
    ? "只删除“XULONG pasa”明确登记的本地键，不会清除同一网站下其他项目的数据，也不会读取或导出麦克风录音。"
    : "ลบเฉพาะคีย์ในเครื่องที่แอป “XULONG pasa” ระบุไว้ชัดเจน ไม่แตะข้อมูลของโครงการอื่นในเว็บไซต์เดียวกัน และไม่อ่านหรือส่งออกเสียงไมโครโฟน");
...
function renderThaiSpeakerProfile() {
  ...
  text("#speaker-form-note", isZh
    ? "优先影响已提供男女句式的课程；男句式暂无固定男声时，播放会使用设备备用音。各档都保持原意。"
    : "มีผลกับบทเรียนที่มีรูปประโยคหญิงและชาย หากยังไม่มีเสียงผู้ชายแบบคงที่ ระบบจะใช้เสียงสำรองของอุปกรณ์ โดยทุกระดับยังคงความหมายเดิม");
...
function renderProfileSettingGroups() {
  const isZh = currentDirection === "zh-th";
  const groups = [
    ["#profile-display-settings", "#profile-display-settings-title", "#profile-display-settings-note", isZh ? "外观与播放" : "หน้าตาและการเล่น", isZh ? "主题、说话者、语速和动画" : "ธีม รูปแบบผู้พูด ความเร็ว และภาพเคลื่อนไหว"],
    ["#profile-audio-settings", "#profile-audio-settings-title", "#profile-audio-settings-note", isZh ? "声音与离线" : "เสียงและออฟไลน์", isZh ? "声线试听、安装与离线语音" : "ลองเสียง ติดตั้ง และเสียงออฟไลน์"],
    ["#profile-data-settings", "#profile-data-settings-title", "#profile-data-settings-note", isZh ? "数据与说明" : "ข้อมูลและคำอธิบาย", isZh ? "表达原则、导出、清除和内容披露" : "หลักการภาษา ส่งออก ล้างข้อมูล และคำชี้แจง"]
  ];
  groups.forEach(([selector, titleSelector, noteSelector, titleValue, noteValue]) => {
    const details = $(selector);
    if (!details) return;
    text(titleSelector, titleValue);
    text(noteSelector, noteValue);
    const action = details.querySelector("summary em");
    if (action) action.textContent = details.open ? (isZh ? "收起" : "ย่อ") : (isZh ? "展开" : "เปิด");
  });
}
...
function applyDirection(direction, persist = true) {
  ...
  text("#direction-edition-label", isChineseUi ? "出发地" : "จุดเริ่มต้น");
  text("#direction-eyebrow", isChineseUi ? "折声界 · 中泰双界冒险" : "โลกเสียงพับ · ผจญภัยสองโลกจีน–ไทย");
  html("#direction-title", isChineseUi ? "跨过语言，<br><em>再次相遇</em>" : "ข้ามกำแพงภาษา<br><em>เพื่อพบกันอีกครั้ง</em>");
  text("#direction-intro-copy", isChineseUi
    ? "小艾与 CHANINDA 失散在两个世界。学会彼此的语言，找回通往对方的路。"
    : "小艾กับ CHANINDA พลัดพรากไปคนละโลก เรียนภาษาของกันและกันเพื่อหาทางกลับมาพบกัน");
  text("#direction-hint-enter", isChineseUi ? "点路线继续" : "แตะเส้นทางเพื่อไปต่อ");
  text("#direction-hint-account", isChineseUi ? "无需注册" : "ไม่ต้องสมัคร");
  text("#direction-hint-offline", isChineseUi ? "可随时换方向" : "เปลี่ยนภาษาได้เสมอ");
  ...
  $("#reset-onboarding").setAttribute("aria-label", isChineseUi ? "重新选择学习目标和场景语气" : "เลือกเป้าหมายและระดับภาษาตามสถานการณ์ใหม่");
  ...
  $("#vibe-slider").setAttribute("aria-label", isChineseUi ? "选择场景语气" : "เลือกระดับภาษาตามสถานการณ์");
  ...
  text("#setup-eyebrow", isChineseUi ? "先选目标 · 随时可换" : "เลือกเป้าหมายก่อน · เปลี่ยนได้เสมอ");
  html("#onboarding-title", isChineseUi ? "今天先从<br><em>哪种场景开始？</em>" : "วันนี้อยากเริ่มจาก<br><em>สถานการณ์แบบไหน?</em>");
  html("#setup-lede", isChineseUi
    ? "先按学习目标进入；应用默认推荐自然日常。想精细比较时，再展开全部五档。"
    : "เริ่มจากเป้าหมายการเรียน โดยแนะนำภาษาสุภาพในชีวิตประจำวัน หากต้องการเปรียบเทียบละเอียด ค่อยเปิดดูครบทั้ง 5 ระดับ");
  text("#setup-goal-heading", isChineseUi ? "你最想先解决什么？" : "อยากเริ่มแก้เรื่องไหนก่อน?");
  text("#setup-goal-note", isChineseUi ? "推荐从日常开口开始" : "แนะนำให้เริ่มจากการพูดในชีวิตประจำวัน");
  text("#goal-daily-title", isChineseUi ? "日常开口" : "พูดในชีวิตประจำวัน");
  text("#goal-daily-copy", isChineseUi ? "旅行、点单、问路" : "เที่ยว สั่งอาหาร ถามทาง");
  text("#goal-friends-title", isChineseUi ? "熟人聊天" : "คุยกับคนสนิท");
  text("#goal-friends-copy", isChineseUi ? "朋友、同学、松弛口语" : "เพื่อน เพื่อนร่วมชั้น ภาษากันเอง");
  text("#goal-recognize-title", isChineseUi ? "处理冲突与边界" : "รับมือความขัดแย้งและขอบเขต");
  text("#goal-recognize-copy", isChineseUi ? "暂停、设限、安全退出" : "หยุด ตั้งขอบเขต ถอนตัวอย่างปลอดภัย");
  text("#setup-all-levels-title", isChineseUi ? "比较全部五档" : "เปรียบเทียบครบทั้ง 5 ระดับ");
  text("#setup-all-levels-note", isChineseUi ? "正式、日常、熟人、直接与冲突降级" : "ทางการ ชีวิตประจำวัน คนสนิท พูดตรง และคลี่คลายความขัดแย้ง");
  text("#setup-scale-safe", isChineseUi ? "适用更广" : "ใช้ได้กว้างกว่า");
  text("#setup-scale-note", isChineseUi ? "档位描述说法，不评价人" : "ระดับอธิบายวิธีพูด ไม่ตัดสินคน");
  text("#setup-scale-risk", isChineseUi ? "情境更强" : "เฉพาะสถานการณ์มากขึ้น");
  $("#setup-mode-list").setAttribute("aria-label", isChineseUi ? "选择场景语气" : "เลือกระดับภาษาตามสถานการณ์");
  html("#setup-axis-note", isChineseUi
    ? "<span><b>表达目标</b>决定说什么</span><i aria-hidden=\"true\">×</i><span><b>人物关系</b>决定怎么说</span>"
    : "<span><b>เป้าหมาย</b>กำหนดว่าจะพูดอะไร</span><i aria-hidden=\"true\">×</i><span><b>ความสัมพันธ์</b>กำหนดวิธีพูด</span>");
  $$("#setup-goal-picker [data-onboarding-goal]").forEach(button => {
    button.dataset.speakText = $("strong", button)?.textContent || button.textContent.trim();
    button.dataset.speakLang = data.interfaceLang;
    button.dataset.speechTrack = "navigation";
  });
  text("#mode-picker-label", data.setup.picker);
  text("#start-app-label", isChineseUi ? "查看这个目标" : "ดูตัวอย่างเป้าหมายนี้");
  text("#quick-adventure-label", isChineseUi ? "先试玩校园冒险" : "ลองผจญภัยในมหาวิทยาลัยก่อน");
  text("#quick-adventure-note", isChineseUi ? "使用当前目标进入；课程设置以后再看。" : "ใช้เป้าหมายปัจจุบัน ตั้งค่าบทเรียนภายหลังได้");
  $("#start-app").dataset.speakText = isChineseUi ? "查看这个目标" : "ดูตัวอย่างเป้าหมายนี้";
  $("#peek-home").dataset.speakText = data.setup.peek;
  text("#peek-home", data.setup.peek);
  text("#confirm-eyebrow", isChineseUi ? "确认学习路线" : "ยืนยันเส้นทางการเรียน");
  ...
  text("#home-register-kicker", isChineseUi ? "今天练什么 · 场景语气" : "วันนี้ฝึกอะไร · ระดับภาษาตามสถานการณ์");
  ...
  text("#home-role-voice", isChineseUi ? "安全边界 · 可以跟读" : "ขอบเขตปลอดภัย · ฝึกพูดตามได้");
  text("#main-menu-kicker", isChineseUi ? "放学后俱乐部 / 泰国篇" : "ชมรมหลังเลิกเรียน / เส้นทางจีน");
  text("#main-menu-title", isChineseUi ? "下课了，去冒险。" : "เลิกเรียนแล้ว ไปผจญภัยกัน");
  text("#main-menu-subtitle", isChineseUi ? "学会一句话，多一招闯世界。" : "เรียนรู้ทีละประโยค แล้วออกไปสำรวจโลก");
  ...
  text("#main-menu-mode-label", isChineseUi ? "场景语气" : "ระดับภาษาตามสถานการณ์");
  ...
  const menuCopy = isChineseUi
    ? [["先听一遍", "3 句 · 约 3 分钟"], ["词汇发音", "3415 张训练卡"], ["情景对话", "8 场景 · 可离线"], ["打怪对战", "14 玩法 · 可双人"]]
    : [["ฟังก่อนหนึ่งรอบ", "3 ประโยค · ราว 3 นาที"], ["คำศัพท์และเสียง", "3,000 การ์ดฝึก"], ["บทสนทนาจริง", "8 ฉาก · ออฟไลน์"], ["ล่ามอนสเตอร์", "14 เกม · เล่นสองคน"]];
  ...
  const menuSpeech = isChineseUi
    ? [["#main-menu-direction", "切换学习方向"], ["#main-menu-mode", "切换场景语气"], ["#main-menu-lesson", "开始今日课程"]]
    : [["#main-menu-direction", "เปลี่ยนเส้นทางการเรียน"], ["#main-menu-mode", "เปลี่ยนระดับภาษาตามสถานการณ์"], ["#main-menu-lesson", "เริ่มบทเรียนวันนี้"]];
  ...
  text("#vibe-eyebrow", isChineseUi ? "当前场景语气示例" : "ตัวอย่างระดับภาษาตามสถานการณ์");
  text("#vibe-heading", isChineseUi ? "同一句，怎么换语气" : "ประโยคเดียว เปลี่ยนระดับอย่างไร");
  text("#vibe-info", isChineseUi ? "随场景语气更新" : "เปลี่ยนตามสถานการณ์");
  ...
  text("#battle-vision-cta-meta", data.ui.battleHeroMeta);
  text("#battle-vision-cta-label", data.ui.battleHeroCta);
  text("#battle-vision-sigil", data.ui.battleHeroSigil);
  text("#arcade-loading-status", isChineseUi ? "正在把词库进度接入玩法…" : "กำลังเชื่อมความคืบหน้าคำศัพท์เข้ากับเกม…");
  text("#vocab-loading-status", isChineseUi ? "正在装入本级 500 张训练卡…" : "กำลังโหลดการ์ดฝึก 500 ใบของระดับนี้…");
  if (!window.ArcadeUI) text("#arcade-expand-label", isChineseUi ? "正在准备 14 种玩法" : "กำลังเตรียมเกม 14 แบบ");
  ...
  html("#profile-level-label", `<strong id="profile-level">${currentDirection === "zh-th" ? "学习记录" : "บันทึกการเรียน"}</strong>`);
  ...
  $("#change-mode").dataset.speakText = isChineseUi ? "切换场景语气" : "เปลี่ยนระดับภาษาตามสถานการณ์";
  $("#change-mode").dataset.speakLang = navigationLanguage;
  $("#show-method").dataset.speakText = isChineseUi ? "查看场景语气说明" : "ดูคำอธิบายระดับภาษาตามสถานการณ์";
  ...
  text("#alai-voice-title", currentDirection === "zh-th" ? "导航声音" : "เสียงนำทาง");
  ...
  const compactNav = isChineseUi
    ? { home: "世界", live: "练习", battle: "战斗", profile: "记录" }
    : { home: "โลก", live: "ฝึก", battle: "ต่อสู้", profile: "บันทึก" };
  Object.entries(compactNav).forEach(([key, value]) => text(`#nav-${key}`, value));
  $$('.bottom-nav [data-nav]').forEach(button => button.setAttribute('aria-label', compactNav[button.dataset.nav] || button.textContent));
  $('.logo-button').setAttribute('aria-label', isChineseUi ? '返回世界' : 'กลับสู่โลก');
  $('.logo-button').dataset.speakText = isChineseUi ? '返回世界' : 'กลับสู่โลก';
  ...
  text("#lesson-scene-label", data.ui.lessonScene); text("#npc-editorial-mark", currentDirection === "zh-th" ? "情景对话" : "บทสนทนา");
  ...
  renderLocalProgress();
  window.SawadeekaCommerce?.setLocale?.(direction);
}

function renderVibeTicks() {
  $("#vibe-ticks").innerHTML = config().modes.map((mode, index) => {
    const example = comparisonExample(index);
    return `<button data-index="${index}" data-speak-text="${escapeHtml(example.target)}" data-speak-lang="${config().targetLang}" data-speech-track="standard" aria-label="${escapeHtml(`${mode.code} ${registerName(index)}`)}" aria-pressed="${index === currentMode}"><span>${mode.code}</span><small>${escapeHtml(registerName(index))}</small></button>`;
  }).join("");
}
...
function renderOnboardingModePreview(index = pendingMode) {
  ...
  const contextEffect = isZh
    ...
    : [
        ...
        "เหมาะเมื่อมีเวลาจำกัดและต้องสื่อสารขอบเขตให้ชัด",
        "เหมาะเมื่อเริ่มมีความขัดแย้ง: หยุดก่อน ตั้งขอบเขต และออกจากสถานการณ์อย่างปลอดภัย"
      ][index];
  ...
  preview.classList.remove("is-recognition");
  ...
  $("#setup-preview-reading").classList.remove("hidden");
  ...
  text("#setup-preview-voice-kind", isZh ? "学习示范音" : "เสียงตัวอย่างเพื่อเรียน");
  voiceKind.classList.remove("role");
  voiceKind.classList.add("standard");
  $("#setup-preview-play").dataset.speechTrack = "standard";
  $("#setup-preview-play").setAttribute("aria-label", isZh ? "播放学习示范音" : "ฟังเสียงตัวอย่างเพื่อเรียน");
  text("#setup-preview-slow", isZh ? "慢听" : "ฟังช้า");
  $("#setup-preview-slow").classList.remove("hidden");
}

function updateOnboardingPreviewAction() {
  const isZh = currentDirection === "zh-th";
  const copy = onboardingPreviewAcknowledged
    ? (isZh ? `确认 ${gradeForMode(pendingMode)} · ${registerName(pendingMode)}` : `ยืนยัน ${gradeForMode(pendingMode)} · ${registerName(pendingMode)}`)
    : (isZh ? "查看这个目标的完整示例" : "ดูตัวอย่างเต็มของเป้าหมายนี้");
...
function renderOnboardingConfirmation() {
  ...
  text("#confirm-voice-kind", isZh ? "学习示范音" : "เสียงตัวอย่างเพื่อเรียน");
  $("#confirm-voice-kind").classList.remove("role");
  $("#confirm-voice-kind").classList.add("standard");
  text("#confirm-voice-note", isZh ? "用于听清、跟读与对照练习" : "ใช้ฟังให้ชัด ฝึกพูดตาม และเปรียบเทียบเพื่อฝึก");
  const play = $("#confirm-play");
  play.dataset.speechTrack = "standard";
  play.dataset.speechPolicy = "native";
  $("#confirm-play-slow").dataset.speechPolicy = "native";
  play.setAttribute("aria-label", isZh ? "播放学习示范音" : "ฟังเสียงตัวอย่างเพื่อเรียน");
  text("#confirm-play-slow", isZh ? "慢听" : "ฟังช้า");
  $("#confirm-play-slow").classList.remove("hidden");
  text("#confirm-target", sample.target);
  $("#confirm-target").lang = config().targetHtmlLang;
  text("#confirm-reading", sample.reading);
  $("#confirm-reading").classList.remove("hidden");
...
function missionFlowForMode(index = currentMode) {
  const grade = gradeForMode(index);
  if (grade === "S1") return currentDirection === "zh-th"
    ? ["先暂停", "说清边界", "安全离开"]
    : ["หยุดก่อน", "ตั้งขอบเขต", "ออกอย่างปลอดภัย"];
  if (grade === "S2") return currentDirection === "zh-th"
    ? ["理解场景", "直接表达", "确认边界"]
    : ["เข้าใจฉาก", "พูดตรง", "ยืนยันขอบเขต"];
  return currentDirection === "zh-th"
    ? ["理解场景", "选择本档", "听清再说"]
    : ["เข้าใจฉาก", "เลือกระดับนี้", "ฟังชัดแล้วพูด"];
}

function campusChapterProgress(raw) {
  // Only real, unique opponents from chapter one count; never mutate the save.
  const ids = ["wok-crab", "tuk-gecko", "umbrella-hornbill", "backpack-buffalo", "chalk-tokay", "lantern"];
  try {
    const defeated = JSON.parse(raw || "{}")?.chapters?.["1"]?.defeated;
    const valid = new Set(Array.isArray(defeated) ? defeated.filter(id => ids.includes(id)) : []);
    return { defeated: valid.size, total: ids.length, cleared: ids.map(id => valid.has(id)) };
  } catch (_) { return { defeated: 0, total: ids.length, cleared: ids.map(() => false) }; }
}

function renderCampusJourney() {
  const isZh = currentDirection === "zh-th";
  const progress = campusChapterProgress(safeStorage.getItem(`huilaishi-monster-progress-${currentDirection}`));
  text("#home-campus-kicker", isZh ? "散页之城 · 泰国篇 / 01" : "เมืองหน้ากระดาษ · เส้นทางจีน / 01");
  text("#home-campus-title", isZh ? "风从暹罗来" : "เสียงจากเมืองจีน");
  text("#home-campus-note", isZh ? "河畔校园 · 岔路奇遇 · 双人合击" : "ตรอกริมคลอง · ทางเลือก · ท่าคู่หู");
  const launch = document.querySelector(".campus-launch");
  if (launch) {
    launch.dataset.journey = isZh ? "thailand" : "china";
    launch.dataset.restored = String(progress.defeated === progress.total);
  }
  text("#home-scene-location", isZh ? "泰国 · 河畔校园" : "จีน · ตรอกริมคลอง");
  text("#home-scene-story", progress.defeated === progress.total ? (isZh ? "舞台重新亮起，下一段旅程等你们。" : "เวทีกลับมาเปิดแล้ว พร้อมเดินทางต่อไหม?") : (isZh ? "手册被风吹散了。和搭档，找回城市的声音。" : "ตามหาคู่มือที่ปลิวหายไปกับคู่หูกันเถอะ"));
  text("#home-scene-duo", isZh ? "小艾 × CHANINDA / 放学后俱乐部" : "小艾 × CHANINDA / ชมรมหลังเลิกเรียน");
  const action = progress.defeated === progress.total
    ? (isZh ? "重访首章" : "เล่นบทแรกอีกครั้ง")
    : progress.defeated > 0 ? (isZh ? "继续首章" : "เล่นบทแรกต่อ") : (isZh ? "进入首章" : "เริ่มบทแรก");
  text("#home-campus-action", action);
  text("#home-campus-progress", isZh ? `已击败 ${progress.defeated} / ${progress.total}` : `ชนะแล้ว ${progress.defeated} / ${progress.total}`);
  $("#home-campus-pips").innerHTML = progress.cleared.map(done => `<i class="${done ? "is-cleared" : ""}"></i>`).join("");
  $("#home-campus-start").setAttribute("aria-label", `${action} · ${$("#home-campus-progress").textContent}`);
  $("#home-campus-start").dataset.speakText = action;
  $("#home-campus-start").dataset.speakLang = config().interfaceLang;
}

async function quickStartCampusAdventure() {
  const button = $("#quick-adventure");
  if (!button || button.disabled || $("#onboarding").classList.contains("hidden")) return;
  button.disabled = true;
  try {
    applyMode(pendingMode);
    safeStorage.setItem(onboardingKey(), "1");
    navigate("home", { history: "root" });
    await openCampusJourney();
  } finally { button.disabled = false; }
}

async function openCampusJourney() {
  const button = $("#home-campus-start");
  if (button.disabled) return;
  const requestedDirection = currentDirection;
  button.disabled = true;
  button.setAttribute("aria-busy", "true");
  text("#home-campus-action", currentDirection === "zh-th" ? "正在准备…" : "กำลังเตรียม…");
  try {
    const ready = await prepareViewFeatures("battle");
    if (currentDirection !== requestedDirection || !$("#view-home").classList.contains("active") || $("#main-app").classList.contains("hidden")) return;
    navigate("battle");
    if (ready) window.ArcadeUI?.openStoryChapter?.();
  } finally {
...
function renderRegisterHome() {
  ...
  text("#main-menu-title", isZh ? "离她，再近一步。" : "ใกล้เขาอีกก้าว");
  text("#main-menu-subtitle", isZh ? "小艾 · 莲潮港路线。把学会的话，变成重逢的力量。" : "CHANINDA · เส้นทางเมืองสะพานหมึก เปลี่ยนถ้อยคำที่เรียนเป็นพลังเพื่อพบกัน");
  renderCampusJourney();
  renderHubAdventure();
  const compactFlow = isZh ? ["听", "选", "说"] : ["ฟัง", "เลือก", "พูด"];
  ...
  $("#home-role-voice").classList.add("hidden");
  ...
  text("#mission-npc", isZh ? "对应当前档" : "ตรงกับระดับนี้");
  ...
  text("#main-menu-lesson-title", complete
    ? (isZh ? "再练一遍" : "ฝึกอีกครั้ง")
    : (isZh ? "先听一遍" : "ฟังก่อนหนึ่งรอบ"));
  text("#main-menu-lesson-copy", isZh ? "3 句 · 约 3 分钟" : "3 ประโยค · ราว 3 นาที");
  ...
  const heroVoice = $("#home-brand-voice");
  const heroVoiceLabel = isZh ? "听今天一句" : "ฟังประโยควันนี้";
  text("#home-brand-voice-label", heroVoiceLabel);
  heroVoice.dataset.speakText = primaryTarget;
  heroVoice.dataset.speakLang = config().targetLang;
  heroVoice.setAttribute("aria-label", `${heroVoiceLabel}：${primaryTarget}`);
}
...
function lessonAnswerCard(variant, grade, correct = false, note = "") {
  ...
  return {
    text: answer.target,
    // Keep the register verdict out of the option before the learner commits.
    // Showing “S4 / S5 / S3” beside a question that asks for S4 turns a
    // contextual judgement into a label-matching exercise.
    sub: answer.reading || "",
    reveal: [`${grade} · ${label}`, note].filter(Boolean).join(" · "),
...
function curriculumLessons() {
  ...
  return route.steps.map(step => {
    ...
    const answers = rotateLessonAnswers([
    ...
    const question = isZh
      ? `哪句符合 ${grade}「${registerName()}」？`
      : `ประโยคใดตรงกับ ${grade} “${registerName()}”?`;
    ...
    return {
      ...
      npc: scenario,
      npcRoman: "",
      npcLang: config().interfaceLang,
      audioTarget: scenario,
      audioLang: config().interfaceLang,
      audioTrack: "standard",
      audioLabel: isZh ? "听场景任务" : "ฟังโจทย์สถานการณ์",
      answers,
      feedback,
      comparePair: null
    };
...
function renderVibePreview(index = currentMode) {
  ...
  $("#speak-vibe").dataset.speechTrack = "standard";
  $("#speak-vibe-slow").dataset.speechTrack = "standard";
...
function renderOnboardingGoals() {
  const selectedGoal = onboardingGoalForMode(pendingMode);
  $$("#setup-goal-picker [data-onboarding-goal]").forEach(button => {
    const selected = button.dataset.onboardingGoal === selectedGoal;
    button.classList.toggle("selected", selected);
    button.setAttribute("aria-pressed", String(selected));
  });
  const allLevels = $("#setup-all-levels");
  if (allLevels && !selectedGoal) allLevels.open = true;
}

function renderModeList() {
  $("#mode-list").innerHTML = config().modes.map((mode, index) => `
    <button class="mode-option ${index === pendingMode ? "selected" : ""}" data-mode="${index}" data-speak-text="${escapeHtml(comparisonExample(index).target)}" data-speak-lang="${config().targetLang}" data-speech-track="standard" aria-pressed="${index === pendingMode}" style="--mode-color:${sharedColors[index].color}">
      ...
      <span class="risk-chip">${escapeHtml(registerPracticePolicy(index))}</span>
    </button>`).join("");

  const setupList = $("#setup-mode-list");
  if (setupList) {
    setupList.innerHTML = config().modes.map((mode, index) => `
      <button class="setup-mode-option ${index === pendingMode ? "selected" : ""}" data-setup-mode="${index}" data-speak-text="${escapeHtml(comparisonExample(index).target)}" data-speak-lang="${config().targetLang}" data-speech-track="standard" aria-pressed="${index === pendingMode}" style="--mode-color:${sharedColors[index].color}">
        ...
        <span class="setup-option-risk">${escapeHtml(registerPracticePolicy(index))}</span>
...
function selectPendingMode(index, source = "sheet") {
  pendingMode = index;
  if (isSetupSelectionSource(source)) {
    previewPendingMode(index);
    onboardingPreviewAcknowledged = true;
    if (source === "setup-goal") $("#setup-all-levels").open = false;
  }
  renderModeList();
  if (isSetupSelectionSource(source)) updateOnboardingPreviewAction();
  requestAnimationFrame(() => {
...
function renderBattle() {
  ...
  if (!sample) {
    ...
    const correctVariant = variantAnswer(intentId, grade, sample.variant);
    const distractorGrades = ({ S5: ["S4", "S3"], S4: ["S5", "S3"], S3: ["S4", "S2"], S2: ["S4", "S3"], S1: ["S4", "S2"] }[grade] || ["S4", "S3"]);
    const options = rotateLessonAnswers([
      lessonAnswerCard(correctVariant, grade, true),
    ...
    currentBattleQuiz = {
      options,
      source: null,
      correct: isZh ? `判断正确：这句符合 ${grade}「${registerName()}」。` : `ถูกต้อง: ประโยคนี้ตรงกับ ${grade} “${registerName()}”`,
    ...
    text("#battle-question", isZh ? `哪句符合 ${grade}「${registerName()}」？` : `ประโยคใดตรงกับ ${grade} “${registerName()}”?`);
  }
  $("#battle-source").classList.add("hidden");
  $("#battle-options").innerHTML = currentBattleQuiz.options.map((option, i) => {
    ...
    const sub = option.meaning || option.reading || option.sub || "";
    const reveal = option.reveal || "";
    const line = { target, roman: option.roman || option.reading || "", thReading: option.thReading || null };
    return `<button data-battle="${i}" data-correct="${option.correct}"><span>${String.fromCharCode(65 + i)}</span><b lang="${data.targetHtmlLang}">${escapeHtml(target)}</b>${sub ? `<small>${escapeHtml(sub)}</small>` : ""}${reveal ? `<em class="battle-register-reveal" data-battle-register hidden>${escapeHtml(reveal)}</em>` : ""}${phoneticMarkup(line)}</button>`;
  }).join("");
...
function chooseBattle(index) {
  ...
  $$("#battle-options [data-battle-register]").forEach(node => { node.hidden = false; });
...
function normalizeForMatch(value) {
  return String(value || "")
    ...
    // Removing every Unicode mark can collapse distinct Thai words.
    .replace(/[\u0300-\u036f]/gu, "")
    .toLowerCase()
...
function matchLiveOptionForScene(scene, value, direction, modeIndex) {
  ...
  const preferredLevel = desiredLevel;
...
function renderPhrases(filter = "all") {
  ...
  text("#library-subtitle", currentDirection === "zh-th" ? "只显示当前场景语气；切换后，整组内容一起更新。" : "แสดงเฉพาะระดับตามสถานการณ์ปัจจุบัน เมื่อเปลี่ยนแล้วเนื้อหาทั้งชุดจะอัปเดตตาม");
  $("#phrase-list").innerHTML = list.map(item => {
    ...
    const tapAttrs = `role="button" tabindex="0" data-tap-speak data-speak-text="${escapeHtml(answer.target)}" data-speak-lang="${data.targetLang}" data-speech-track="standard"`;
    return `<article class="phrase-card">
      ...
      <button class="phrase-audio" data-phrase="${encodeURIComponent(answer.target)}" data-track="standard" data-speech-policy="native" data-speech-track="standard" aria-label="${currentDirection === "zh-th" ? "播放学习示范音" : "ฟังเสียงตัวอย่างเพื่อเรียน"}"><svg><use href="#i-volume"></use></svg></button>
    </article>`;
  }).join("");
}
...
function lessonInteractionCopy(phase) {
  ...
  const copyByPhase = isZh ? {
    listen: ["第 1 步", "先听清场景任务", "点黄色声音键听场景提示；这里不会提前播放正确答案。"],
    ...
    listen: ["ขั้นที่ 1", "ฟังโจทย์สถานการณ์ให้ชัด", "แตะปุ่มเสียงสีเหลืองเพื่อฟังโจทย์ ขั้นนี้จะยังไม่เปิดเสียงคำตอบที่ถูก"],
...
function setLessonAnswerAccess(unlocked) {
  const list = $("#answer-list");
  if (!list) return;
  const step = curriculumLessons()[lessonStep];
  list.classList.toggle("is-locked", !unlocked);
  list.setAttribute("aria-hidden", String(!unlocked));
  list.toggleAttribute("inert", !unlocked);
  $$("[data-answer]", list).forEach(button => { button.disabled = !unlocked; });
  $$("[data-answer-audio]", list).forEach(button => {
    const answer = step?.answers?.[Number(button.dataset.answerAudio)];
    button.disabled = !unlocked || answer?.grade === "S1";
  });
  $("#lesson-listen-lock")?.classList.toggle("hidden", unlocked);
  $("#lesson-scroll-hint")?.classList.toggle("hidden", !unlocked);
}

function prepareLessonAnswerRetry() {
  checked = false;
  lessonNeedsRetry = false;
  selectedAnswer = null;
  lessonVoiceGate = null;
  $("#lesson-feedback").classList.add("hidden");
  $$("#answer-list [data-answer]").forEach(button => {
    button.classList.remove("selected", "wrong");
    button.setAttribute("aria-pressed", "false");
  });
  text("#lesson-next", config().ui.check);
  $("#lesson-next").disabled = true;
  $("#lesson").classList.add("awaiting-answer");
  setLessonAnswerAccess(true);
  setLessonInteractionPhase("retry-answer");
  const marked = $("#answer-list [data-answer].correct");
  requestAnimationFrame(() => marked?.focus?.({ preventScroll: true }));
}
...
function renderLessonStep() {
  ...
  $("#speak-npc").classList.remove("role-voice");
  $("#answer-list").innerHTML = step.answers.map((answer, i) => {
    const speakLang = answer.target ? data.targetLang : data.interfaceLang;
    const speechAttrs = `data-speak-text="${escapeHtml(answer.text)}" data-speak-lang="${escapeHtml(speakLang)}" data-speech-track="standard"`;
    const audioIcon = "i-volume";
    const optionCode = String.fromCharCode(65 + i);
    const listenLabel = currentDirection === "zh-th" ? `只试听选项 ${optionCode}` : `ฟังเฉพาะตัวเลือก ${optionCode}`;
    const listenAttrs = `${speechAttrs} data-speech-policy="native"`;
    return `<div class="answer-option"><button class="answer-select" type="button" data-answer="${i}" aria-pressed="false" ${speechAttrs}><span>${optionCode}</span><div><b ${answer.target ? `lang="${data.targetHtmlLang}"` : ""}>${escapeHtml(answer.text)}</b>${answer.sub ? `<small>${escapeHtml(answer.sub)}</small>` : ""}${answer.reveal ? `<em class="answer-register-reveal" data-answer-register hidden>${escapeHtml(answer.reveal)}</em>` : ""}${answer.target && answer.reading ? phoneticMarkup({ target: answer.text, roman: answer.reading }) : ""}</div></button><button class="answer-listen" type="button" data-answer-audio="${i}" ${listenAttrs} aria-label="${escapeHtml(listenLabel)}"><svg aria-hidden="true"><use href="#${audioIcon}"></use></svg></button></div>`;
  }).join("");
  text("#lesson-listen-lock-title", currentDirection === "zh-th" ? "先听这一句" : "ฟังประโยคนี้ก่อน");
  text("#lesson-listen-lock-copy", currentDirection === "zh-th" ? "点上面的黄色声音键，答案随后展开。" : "แตะปุ่มเสียงสีเหลืองด้านบน แล้วตัวเลือกจะเปิดออก");
  $("#lesson-feedback").classList.add("hidden");
  ...
  lessonNeedsRetry = false;
  lessonVoiceGate = null;
  setLessonAnswerAccess(false);
  setLessonInteractionPhase("listen");
}

function selectLessonAnswer(index) {
  if (checked || $("#lesson").dataset.lessonPhase === "listen") return;
...
async function runLessonVoiceGate({ allowNetwork = false } = {}) {
  ...
  try { result = await scorer.recognizeTarget({
    ...
    allowNetwork,
    onInterim: interim => {
      if (lessonVoiceGate !== gateState || gateState.step !== lessonStep || !interim) return;
  ...
  if (["local-missing", "network-consent"].includes(result.status)) {
    ...
    if (["no-speech", "timeout"].includes(result.status)) text("[data-lesson-voice-status]", currentDirection === "zh-th" ? "没有听清，这次不计分。可以再试一次，也可以先听读。" : "ยังฟังไม่ชัด รอบนี้ไม่คิดคะแนน ลองอีกครั้งหรือฟังตัวอย่างก่อน");
  } else {
...
function checkOrContinueLesson() {
  ...
  if (!checked) {
    ...
    $$("#answer-list [data-answer-register]").forEach(node => { node.hidden = false; });
...
async function openLocalBattle() {
  ...
  const passButton = $("#pass-phone");
  passButton?.setAttribute("aria-busy", "true");
  if (passButton) passButton.disabled = true;
  try {
    await ensureFeatureBundle("duel");
  } catch (_) {
    showToast(currentDirection === "zh-th" ? "双人对战模块未能加载，请联网后重试" : "โหลดเกมดวลสองคนไม่สำเร็จ โปรดเชื่อมต่ออินเทอร์เน็ตแล้วลองใหม่");
    return;
  } finally {
    passButton?.removeAttribute("aria-busy");
...
function setSheetBackgroundInert(sheet) {
  restoreSheetBackgroundInert();
  // Restoring a previous overlay can reapply its saved inert state to the new sheet.
  // The foreground sheet must be interactive before background states are captured.
  if (sheet) {
    sheet.inert = false;
...
function setSheetVisibility(sheet, visible) {
  if (!sheet) return;
  sheet.classList.toggle("hidden", !visible);
  sheet.setAttribute("aria-hidden", String(!visible));
  sheet.toggleAttribute("inert", !visible);
}

function syncClosedSheetAccessibility() {
  $$(".bottom-sheet").forEach(sheet => setSheetVisibility(sheet, false));
  const backdrop = $("#modal-backdrop");
  backdrop?.setAttribute("aria-hidden", "true");
}

function openSheet(id) {
  document.body.classList.toggle("premium-sheet-open", id === "premium-sheet");
  sheetLastFocus = document.activeElement;
  sheetLastScrollTop = $("#app-scroll")?.scrollTop ?? null;
  const backdrop = $("#modal-backdrop");
...
function closeSheets() {
  ...
  if (arcadeWasOpen && globalThis.ArcadeUI?.requestClose?.() === false) return false;
  clearTimeout(partnerReplyTimer);
  const backdrop = $("#modal-backdrop");
  ...
  const visibleDuel = $("#local-battle-root");
  if (visibleDuel && !visibleDuel.hidden) setSheetBackgroundInert(visibleDuel);
  const focusTarget = sheetLastFocus;
  const scrollTop = sheetLastScrollTop;
  sheetLastFocus = null;
  sheetLastScrollTop = null;
  requestAnimationFrame(() => {
    if (focusTarget?.isConnected) focusTarget.focus?.({ preventScroll: true });
    const appScroll = $("#app-scroll");
    if (appScroll && Number.isFinite(scrollTop)) appScroll.scrollTop = scrollTop;
    // Orientation styles settle one frame later on some Samsung browsers.
    requestAnimationFrame(() => {
      if (appScroll && Number.isFinite(scrollTop)) appScroll.scrollTop = scrollTop;
    });
  });
...
function navigate(view, options = {}) {
  ...
  if (view === "home") renderCampusJourney();
  window.XULONG_WORLD_UI?.show(view, {
    direction: () => currentDirection,
    storage: safeStorage,
    navigate,
    prepareLearning: () => prepareViewFeatures("library"),
    prepareBattle: () => prepareViewFeatures("battle")
  });
...
function stopAlaiVoice() {
  window.XULONG_MUSIC?.release('alai');
  if (!alaiAudio) return;
  alaiAudio.pause();
...
function playAlaiVoice(cue = "intro") {
  ...
  const clear = () => {
    if (alaiAudio === audio) { alaiAudio = null; window.XULONG_MUSIC?.release('alai'); }
...
function setLocalSpeechUi(status) {
  ...
  if (status === "unavailable" && window.HUILAISHI_NATIVE_ANDROID) {
    text("#voice-title", currentDirection === "zh-th" ? "安卓语音识别暂未开放" : "ยังไม่เปิดใช้การรู้จำเสียงในแอป Android");
    text("#voice-status", currentDirection === "zh-th"
      ? "本测试版正在排查系统语音接口兼容问题；可以继续听示范、选句或打字。录音回听不受此限制。"
      : "รุ่นทดสอบนี้กำลังตรวจสอบความเข้ากันได้ของระบบเสียง ยังฟังตัวอย่าง เลือกประโยค พิมพ์ หรือบันทึกเสียงฟังย้อนหลังได้");
  }
}
...
async function prepareLocalSpeech() {
  if (window.HUILAISHI_NATIVE_ANDROID) return setLocalSpeechUi("unavailable");
...
function renderOfflineAudioUi() {
  ...
  const total = Math.max(0, Number(detail.coreTotal) || 535);
  ...
  const progress = total ? `${Math.min(completed, total)}/${total}` : "0/535";
  ...
  text("#offline-audio-size", isZh ? "535 段 · 17.4 MB" : "535 คลิป · 17.4 MB");
  ...
  if (embedded) note = isZh ? "核心语音已经内置在 iOS 应用中，不需要再次缓存。" : "รวมเสียงหลักไว้ในแอป iOS แล้ว ไม่ต้องบันทึกซ้ำ";
...
function updateInstallUi() {
  const ui = offlineConfig()?.ui;
  if (!ui) return;
  const standalone = Boolean(window.HUILAISHI_NATIVE_IOS) || window.matchMedia?.("(display-mode: standalone)").matches || window.navigator.standalone === true;
...
function openIosInstallGuide() {
  ...
  text("#ios-install-title", thai ? "เพิ่มXULONG pasaไปยังหน้าจอโฮม" : "把XULONG pasa放到主屏幕");
...
async function installPwa() {
  ...
  const isSingleFile = window.HUILAISHI_NATIVE_IOS || window.SINGLE_FILE_BUILD || location.protocol === "file:";
  if (isSingleFile) {
    showToast(currentDirection === "zh-th"
      ? (isIOS
...
async function confirmClearLearningData() {
  ...
  const singleFile = Boolean(window.HUILAISHI_NATIVE_IOS) || Boolean(window.SINGLE_FILE_BUILD) || location.protocol === "file:";
  ...
  if (hasWarning) {
    ...
    const cacheNoteZh = singleFile
      ? "iOS 应用内置语音属于应用本身，不是可清除的设备缓存"
      : hasCoreController ? "已收到核心语音缓存清除确认" : "当前未发现受控的核心语音缓存";
    const cacheNoteTh = singleFile
      ? "เสียงที่รวมในแอป iOS เป็นส่วนหนึ่งของแอป ไม่ใช่แคชอุปกรณ์ที่ล้างได้"
...
async function setupPwa() {
  ...
  if (window.HUILAISHI_NATIVE_IOS || window.SINGLE_FILE_BUILD || location.protocol === "file:") {
  ...
  try {
    throw new Error("Service Worker is disabled in the iOS native shell.");
...
function bindEvents() {
  $$(".profile-settings-group").forEach(details => details.addEventListener("toggle", renderProfileSettingGroups));
  ...
  $("#home-campus-start").addEventListener("click", openCampusJourney);
  $("#welcome-back").addEventListener("click", () => showDirection());
  $("#welcome-skip").addEventListener("click", skipWelcome);
  $("#welcome-start").addEventListener("click", () => { void startWelcomeAdventure(); });
  $("#hub-adventure").addEventListener("click", () => { void openHubAdventure(); });
  $("#hub-replay").addEventListener("click", () => { void openHubAdventure(true); });
  $$('[data-comic-replay]').forEach(button => button.addEventListener('click', () => window.XULONG_COMIC?.show({storage:safeStorage,locale:currentDirection==='th-zh'?'th':'zh'})));
  $("#hub-story").addEventListener("click", () => { void openCampusJourney(); });
  $("#hub-study").addEventListener("click", () => navigate("library"));
  $("#hub-collection").addEventListener("click", () => navigate("profile"));
  let homeHeroVoiceTimer = null;
  $("#home-brand-voice").addEventListener("click", () => {
    const hero = $(".home-main-menu-head");
    hero.classList.remove("is-voicing");
    void hero.offsetWidth;
    hero.classList.add("is-voicing");
    clearTimeout(homeHeroVoiceTimer);
    homeHeroVoiceTimer = setTimeout(() => hero.classList.remove("is-voicing"), 760);
  });
  ...
  $("#setup-goal-picker").addEventListener("click", event => {
    const button = event.target.closest("[data-onboarding-goal]");
    if (!button) return;
    const index = Number(button.dataset.goalMode);
    selectPendingMode(index, "setup-goal");
  });
  ...
  $("#accept-risk").addEventListener("click", () => closeSheets());
  $("#modal-backdrop").addEventListener("click", event => {
    if (!localDataClearInProgress && closeSheets() === false) {
      event.preventDefault();
      event.stopImmediatePropagation();
    }
  });
  document.addEventListener("keydown", handleSheetKeydown);
  $$('[data-close-sheet]').forEach(button => button.addEventListener("click", event => {
    pendingMode = currentMode;
    if (closeSheets() === false) {
      event.preventDefault();
      event.stopImmediatePropagation();
    }
  }));
  ...
  $("#quick-adventure")?.addEventListener("click", () => { void quickStartCampusAdventure(); });
  ...
  $("#confirm-play").addEventListener("click", event => {
    ...
    speakText(example.target, config().targetLang, .84, { track: "standard", element: event.currentTarget });
  });
  $("#confirm-play-slow").addEventListener("click", event => {
    const example = comparisonExample(pendingMode);
    speakText(example.target, config().targetLang, .64, { track: "standard", element: event.currentTarget });
  });
  ...
  $("#profile-first-action").addEventListener("click", startLesson);
  ...
  $("#speak-npc").addEventListener("click", event => {
    const step = curriculumLessons()[lessonStep];
    speakText(step.audioTarget || step.npc, step.audioLang || config().targetLang, .82, { track: step.audioTrack || "standard", element: event.currentTarget });
    setLessonAnswerAccess(true);
    setLessonInteractionPhase("choose");
  });
  ...
  $("#battle-source-audio").addEventListener("click", event => {
    if (currentBattleQuiz?.source?.target) speakText(currentBattleQuiz.source.target, config().targetLang, .84, { track: "standard", element: event.currentTarget });
  });
  ...
  $("#quick-replies").addEventListener("click", event => {
    ...
    if (previewButton) {
      ...
      if (option) speakText(option.target, config().targetLang, .84, { track: "standard", element: previewButton });
      return;
    }
...
function init() {
  const reportStage = stage => window.HUILAISHI_REPORT_STARTUP_STAGE?.(stage);
  reportStage("init-events");
  enforceTopLevelContext();
  bindEvents();
  window.SawadeekaCommerce?.bindUi?.({ openSheet, closeSheets, toast: showToast });
  syncClosedSheetAccessibility();
  reportStage("init-preferences");
  ...
  window.HUILAISHI_SPEECH?.setPace?.(speechPace);
  reportStage("init-pronunciation");
  ...
  const samsungStableEntry = Boolean(window.HUILAISHI_NATIVE_LIGHTWEIGHT)
    || /(?:^|[?&])from=samsung-current(?:&|$)/.test(location.search);
  ...
  const firstRunRoute = !product[storedDirection]
    ? "direction"
    : safeStorage.getItem(onboardingKey(currentDirection)) !== "1"
      ? "onboarding-select"
      : null;
  const requestedRoute = samsungStableEntry
    ? (window.HUILAISHI_NATIVE_LIGHTWEIGHT ? firstRunRoute || "home" : "home")
    : firstRunRoute || historyRoute || reloadRoute || "home";
  reportStage("init-route");
  const restoredRoute = restoreApplicationRoute(requestedRoute);
  rememberAppRoute(restoredRoute, "replace");
  reportStage("init-install");
  setupPwa();
  ...
  // Explicit story-preview URL; normal launches continue to honor saved routes.
  if (new URLSearchParams(location.search).get("story") === "1" && !window.HUILAISHI_NATIVE_LIGHTWEIGHT) {
    showDirection({history:"replace"});
    window.XULONG_COMIC?.show({storage:safeStorage,locale:currentDirection==='th-zh'?'th':'zh'});
  }
}
