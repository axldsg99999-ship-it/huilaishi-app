...
(function () {
  ...
  const CURATED = Object.freeze({
    ...
    "ขอน้ำหนึ่งขวดค่ะ ถ้าตอนนี้ไม่สะดวก ฉันรอได้": curated("扣-南-能-库阿特-卡 · 塔-东-尼-麦-萨杜阿克 · 蚕-洛-戴", "khɔ̌ɔ náam nʉ̀ng khùat khâ · thâa tɔɔn-níi mâi sà-dùak · chǎn rɔɔ dâi", "按三段连读；句尾放软，表达清楚但不施压"),
    "เราหยุดก่อน แล้วค่อยคุยกันนะคะ": curated("劳-育-滚 · 莱奥-靠伊-库伊-甘-纳-卡", "rao yùt kɔ̀ɔn · lɛ́ɛo khɔ̂i khui kan ná khá", "先暂停，再约定冷静沟通；纳卡保持柔和"),
