(() => {
  ...
  const COPY = {
    zh: {
      ...
      profileCopy: "主题词库、全游戏、完整怪物远征与发音课",
      profileReady: "查看权益",
      profileOwned: "已永久解锁",
      ...
      freeTitle: "免费体验",
      freeItems: ["生存开口 · 572 张训练卡", "首节发音课", "4 款核心游戏", "怪物故事第 1 章", "开口格斗与均衡赛"],
      proTitle: "永久完整版",
      proItems: ["全部主题 · 3,415 张训练卡", "完整发音课程", "全部 14 款游戏", "完整怪物图鉴与远征", "全部 4 种同机对战"],
      owned: "当前商店账号已永久解锁",
    ...
    th: {
      ...
      freeTitle: "ทดลองฟรี",
      freeItems: ["เอาตัวรอด · การ์ดฝึก 572 ใบ", "บทออกเสียงบทแรก", "เกมหลัก 4 แบบ", "เรื่องมอนสเตอร์บทที่ 1", "ดวลพูดและรอบสมดุล"],
      proTitle: "เวอร์ชันเต็มถาวร",
      proItems: ["ทุกหัวข้อ · การ์ดฝึก 3,415 ใบ", "คอร์สออกเสียงครบ", "เกมครบ 14 แบบ", "สมุดภาพและการผจญภัยมอนสเตอร์", "ดวลในเครื่องครบ 4 แบบ"],
