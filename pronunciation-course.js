  ...
  const COURSES = {
    ...
    "th-zh": {
      ...
      lessons: [
        ...
        {
          id: "zh-jqx", no: "03", title: "j / q / x ไม่ใช่ จ / ช / ซ ตรง ๆ", focus: "ลิ้นด้านหน้าแตะใกล้เพดานแข็ง ริมฝีปากไม่ห่อ",
          explain: "j กับ q มีตำแหน่งใกล้กัน แต่ q พ่นลม ส่วน x เป็นเสียงเสียดแทรกต่อเนื่อง ให้ลิ้นด้านหน้าอยู่สูงหลังฟันล่าง",
          rule: "เมื่อ j/q/x ตามด้วย u ตัว u แทนเสียง ü; จุดสองจุดถูกละในการสะกด แต่ปากยังต้องห่อแบบ ü",
          examples: [
