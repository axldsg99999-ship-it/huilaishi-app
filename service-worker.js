...
const CACHE_NAME = "huilaishi-offline-v71";
const INSTALL_CACHE_NAME = `${CACHE_NAME}-installing`;
const RUNTIME_CACHE_NAME = "huilaishi-runtime-v71";
const BASE_READY_MARKER = "./__huilaishi_base_ready_v71__";
const FULL_READY_MARKER = "./__huilaishi_full_ready_v71__";
const PROGRESS_MARKER = "./__huilaishi_audio_progress_v71__";
const SHELL_PROGRESS_MARKER = "./__huilaishi_shell_progress_v71__";
const AUDIO_PAUSED_MARKER = "./__huilaishi_audio_paused_v71__";
