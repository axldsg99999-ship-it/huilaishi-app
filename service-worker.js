...
const CACHE_NAME = "huilaishi-offline-v70";
const INSTALL_CACHE_NAME = `${CACHE_NAME}-installing`;
const RUNTIME_CACHE_NAME = "huilaishi-runtime-v70";
const BASE_READY_MARKER = "./__huilaishi_base_ready_v70__";
const FULL_READY_MARKER = "./__huilaishi_full_ready_v70__";
const PROGRESS_MARKER = "./__huilaishi_audio_progress_v70__";
const SHELL_PROGRESS_MARKER = "./__huilaishi_shell_progress_v70__";
const AUDIO_PAUSED_MARKER = "./__huilaishi_audio_paused_v70__";
