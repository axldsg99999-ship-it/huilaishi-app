...
5. installs a WebView-free native launcher, an isolated `:course` process,
   legacy-task migration guards, and Android version `12.6.0-samsung.1` / `120600`;
...
`huilaishi-samsung-12.6.0-r1-release.apk`. It normalizes and compares the APK
...
signed S1/R2/R3/12.3-R1/12.4-R1/12.5-R1 release and upgrades it in place to the signed 12.6 R1 artifact.
