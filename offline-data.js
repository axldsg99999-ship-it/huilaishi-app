    ...
    scenarios: [
      {
        ...
        options: [
          ...
          { level: 3, target: "เอาน้ำเปล่าขวดนึงครับ", roman: "ao náam-plàao khùat nʉng khráp", meaning: "来一瓶水。", keywords: ["เอาน้ำเปล่า","ขวดนึง","来瓶水","ao nam plao"], tip: "有礼貌句尾时通常不冒犯，但比 ขอ 更直接。", next: { target: "ได้ค่ะ เอาเย็นไหมคะ", roman: "dâi khâ, ao yen mái khá", meaning: "好的，要冰的吗？" } },
          ...
          { level: 1, target: "เอาน้ำมาดิวะ", roman: "ao náam maa dì wá", meaning: "把水拿来啊。（挑衅）", keywords: ["เอาน้ำมา","ดิวะ","把水拿来","di wa"], risk: true, tip: "命令和挑衅感明显，只用于听懂、防坑，不建议跟说。", next: { target: "ขอโทษนะคะ พูดดี ๆ หน่อยค่ะ", roman: "khɔ̌ɔ-thôot ná khá, phûut dii-dii nɔ̀i khâ", meaning: "不好意思，请好好说话。" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 3, target: "ขอเวลาแป๊บนึงนะครับ", roman: "khɔ̌ɔ wee-laa pɛ́p nʉng ná khráp", meaning: "再给我一小会儿哈。", keywords: ["ขอเวลา","แป๊บนึง","等一下","kho wela"], tip: "轻松餐厅里自然；正式场合可把 แป๊บนึง 换成 อีกสักครู่。", next: { target: "ได้เลยค่ะ พร้อมแล้วเรียกได้นะคะ", roman: "dâi loei khâ, phrɔ́ɔm lɛ́ɛo rîak dâi ná khá", meaning: "好的，准备好后叫我。" } },
          ...
          { level: 1, target: "รอไปก่อน ยังไม่เสร็จวะ", roman: "rɔɔ pai kɔ̀ɔn, yang mâi sèt wá", meaning: "先等着，还没看完呢。（粗鲁）", keywords: ["รอไปก่อน","ยังไม่เสร็จวะ","先等着","wa"], risk: true, tip: "对服务员有命令和不耐烦感，仅用于影视/冲突识别。", next: { target: "กรุณาพูดสุภาพด้วยค่ะ", roman: "kà-rú-naa phûut sù-phâap dûai khâ", meaning: "请礼貌说话。" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 3, target: "ไม่ขึ้นทางด่วนนะครับ", roman: "mâi khʉ̂n thaang-dùan ná khráp", meaning: "不走高速哈。", keywords: ["ไม่ขึ้นทางด่วน","不走高速","mai khuen"], tip: "短但有软化句尾，现场自然；最好在起步前确认。", next: { target: "ได้ครับ จะไปทางธรรมดา", roman: "dâi khráp, jà pai thaang tham-má-daa", meaning: "好的，走普通道路。" } },
          ...
          { level: 1, target: "รีบไปดิ อย่าพาอ้อมนะเว้ย", roman: "rîip pai dì, yàa phaa ɔ̂ɔm ná wə́əi", meaning: "赶紧开，别带我绕路！（挑衅）", keywords: ["รีบไปดิ","อย่าพาอ้อม","绕路","woei"], risk: true, tip: "同时催促和指责司机，可能立即引发争执，只用于识别。", next: { target: "ถ้าไม่ไว้ใจ เชิญลงได้ครับ", roman: "thâa mâi wái-jai, chəən long dâi khráp", meaning: "如果不信任我，可以下车。" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 3, target: "ตอนนี้เช็กอินก่อนเวลาได้ไหมครับ", roman: "tɔɔn-níi chék-in kɔ̀ɔn wee-laa dâi mái khráp", meaning: "现在可以提前入住吗？", keywords: ["เช็กอินก่อนเวลา","提前入住","kon wela"], tip: "清楚自然；若不能入住，可以接着问 ฝากกระเป๋า（寄存行李）。", next: { target: "ห้องยังไม่พร้อมค่ะ แต่ฝากกระเป๋าไว้ก่อนได้นะคะ", roman: "hɔ̂ng yang mâi phrɔ́ɔm khâ, tɛ̀ɛ fàak grà-pǎo wái kɔ̀ɔn dâi ná khá", meaning: "房间还没准备好，不过可以先寄存行李。" } },
          ...
          { level: 1, target: "จองแล้ว หาเองดิ", roman: "jɔɔng lɛ́ɛo, hǎa eeng dì", meaning: "订了，你自己找啊。（无礼）", keywords: ["หาเองดิ","自己找","ha eng di"], risk: true, tip: "把正常核验说成对方无能，可能让服务直接卡住。", next: { target: "กรุณาแจ้งชื่อและแสดงเอกสารด้วยค่ะ", roman: "kà-rú-naa jɛ̂ɛng chʉ̂ʉ lɛ́ sà-dɛɛng èek-kà-sǎan dûai khâ", meaning: "请提供姓名和证件。" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 3, target: "ลดอีกนิดได้ไหมครับ", roman: "lót ìik nít dâi mái khráp", meaning: "可以再便宜一点吗？", keywords: ["ลดอีกนิด","再便宜一点","lot ik nit"], tip: "轻松自然；给出合理整价往往比反复说“便宜点”更好谈。", next: { target: "ลดให้ได้อีกยี่สิบบาทค่ะ", roman: "lót hâi dâi ìik yîi-sìp bàat khâ", meaning: "可以再便宜 20 泰铢。" } },
      ...
      },
      {
        ...
        options: [
          ...
          { level: 3, target: "เกือบเสร็จแล้วครับ ขอเวลาอีกหนึ่งชั่วโมงนะครับ", roman: "kʉ̀ap sèt lɛ́ɛo khráp, khɔ̌ɔ wee-laa ìik nʉ̀ng chûa-moong ná khráp", meaning: "快完成了，再给我一个小时。", keywords: ["เกือบเสร็จ","อีกหนึ่งชั่วโมง","再给一小时"], tip: "关系正常的团队可用，但若已延期最好补具体提交时刻。", next: { target: "โอเคครับ เสร็จแล้วส่งมาได้เลย", roman: "oo-khee khráp, sèt lɛ́ɛo sòng maa dâi loei", meaning: "好的，完成后直接发来。" } },
          ...
          { level: 1, target: "เร่งอะไรนักหนา ไม่เห็นเหรอว่ายุ่งอยู่", roman: "rêng à-rai nák-nǎa, mâi hěn rə̌ə wâa yûng yùu", meaning: "催什么催，没看见正忙吗？", keywords: ["เร่งอะไรนักหนา","ยุ่งอยู่","催什么催"], risk: true, tip: "直接顶撞主管，可能触发正式谈话，只用于冲突识别。", next: { target: "นี่คือการคุยเรื่องงาน ไว้เราคุยกันเป็นการส่วนตัวครับ", roman: "nîi khʉʉ gaan khui rʉ̂ang ngaan, wái rao khui kan pen gaan sùan-tua khráp", meaning: "这是工作沟通，稍后我们单独谈。" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 2, target: "ชื่อมินต์เหรอ ชื่อน่ารักดี", roman: "chʉ̂ʉ min rə̌ə, chʉ̂ʉ nâa-rák dii", meaning: "叫 Mint 吗？名字挺可爱的。", keywords: ["ชื่อน่ารัก","名字可爱","na rak"], risk: true, tip: "轻度暧昧；对方没有释放亲近信号时要观察反应。", next: { target: "ขอบคุณนะ ชื่อนี้แม่ตั้งให้", roman: "khɔ̀ɔp-khun ná, chʉ̂ʉ níi mɛ̂ɛ tâng hâi", meaning: "谢谢，这名字是妈妈取的。" } },
          { level: 1, target: "มีแฟนยัง", roman: "mii fɛɛn yang", meaning: "有对象了吗？", keywords: ["มีแฟนยัง","有对象吗","mi faen"], risk: true, tip: "不是脏话，但初次见面就问很私人，低语域风险也可能来自越界。", next: { target: "เพิ่งรู้จักกัน ขอไม่ตอบเรื่องนี้นะ", roman: "phə̂ng rúu-jàk kan, khɔ̌ɔ mâi tɔ̀ɔp rʉ̂ang níi ná", meaning: "我们才刚认识，这个问题我不想回答。" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 2, target: "เร็ว ๆ มีคนไม่ไหวแล้ว!", roman: "reo-reo, mii khon mâi wǎi lɛ́ɛo", meaning: "快点，有人不行了！", keywords: ["เร็ว ๆ","ไม่ไหวแล้ว","快点","不行了"], risk: true, tip: "急不是问题，但“有人不行了”信息太模糊；立刻补症状和位置。", next: { target: "อยู่ที่ไหนครับ แล้วผู้ป่วยมีอาการอะไร", roman: "yùu thîi nǎi khráp, lɛ́ɛo phûu-pùai mii aa-gaan à-rai", meaning: "在哪里？病人有什么症状？" } },
    ...
    scenarios: [
      {
        ...
        options: [
          ...
          { level: 1, target: "说了不要，烦不烦？", roman: "Shuō le bú yào, fán bu fán?", meaning: "ก็บอกว่าไม่เอาไง น่ารำคาญไหม?", keywords: ["烦不烦","说了不要","fan bu fan","น่ารำคาญ"], risk: true, tip: "เป็นการตำหนิและหาเรื่องพนักงาน ฟังให้รู้ทันเท่านั้น", next: { target: "请您注意说话方式。", roman: "Qǐng nín zhùyì shuōhuà fāngshì.", meaning: "กรุณาระวังวิธีพูดด้วยครับ/ค่ะ" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 1, target: "两个人，赶紧给我找个位子。", roman: "Liǎng ge rén, gǎnjǐn gěi wǒ zhǎo ge wèizi.", meaning: "สองคน รีบหาที่ให้ฉันเดี๋ยวนี้", keywords: ["赶紧","给我找","ganjin","รีบหา"], risk: true, tip: "赶紧 + 给我 เป็นคำเร่งและคำสั่ง เสียมารยาทชัดเจน", next: { target: "请您耐心等待，不要催促。", roman: "Qǐng nín nàixīn děngdài, bú yào cuīcù.", meaning: "กรุณารออย่างใจเย็นและอย่าเร่งพนักงาน" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 1, target: "虹桥，赶紧的，别给我绕路！", roman: "Hóngqiáo, gǎnjǐn de, bié gěi wǒ ràolù!", meaning: "หงเฉียว รีบ ๆ แล้วอย่าพาฉันอ้อมทาง!", keywords: ["赶紧的","别给我绕路","raolu","อย่าอ้อม"], risk: true, tip: "เป็นทั้งคำสั่งและข้อกล่าวหา อาจเกิดการโต้เถียงทันที", next: { target: "请您尊重司机。不放心的话，可以取消订单。", roman: "Qǐng nín zūnzhòng sījī. Bù fàngxīn de huà, kěyǐ qǔxiāo dìngdān.", meaning: "กรุณาให้เกียรติคนขับ หากไม่ไว้ใจสามารถยกเลิกได้" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 1, target: "催什么催，没看我正忙吗？", roman: "Cuī shénme cuī, méi kàn wǒ zhèng máng ma?", meaning: "จะเร่งอะไร ไม่เห็นหรือว่ากำลังยุ่ง?", keywords: ["催什么催","正忙吗","cui shenme cui"], risk: true, tip: "ย้อนและท้าทายหัวหน้าโดยตรง อาจนำไปสู่การตักเตือน", next: { target: "这是工作沟通，请你冷静一下。稍后我们单独谈。", roman: "Zhè shì gōngzuò gōutōng, qǐng nǐ lěngjìng yíxià. Shāohòu wǒmen dāndú tán.", meaning: "นี่เป็นการสื่อสารงาน กรุณาใจเย็น แล้วคุยกันส่วนตัว" } }
        ],
      ...
      },
      {
        ...
        options: [
          ...
          { level: 1, target: "关你什么事？别套近乎。", roman: "Guān nǐ shénme shì? Bié tào jìnhu.", meaning: "เกี่ยวอะไรกับคุณ? อย่ามาตีสนิท", keywords: ["关你什么事","别套近乎","guan ni shenme shi"], risk: true, tip: "เป็นการไล่และแสดงความเป็นศัตรู บทสนทนาจะจบทันที", next: { target: "好吧，那不打扰了。", roman: "Hǎo ba, nà bù dǎrǎo le.", meaning: "โอเค งั้นไม่รบกวนแล้ว" } }
        ],
