...
$MonsterPaperLanternData = "data:image/webp;base64,$([Convert]::ToBase64String([IO.File]::ReadAllBytes((Join-Path $AppDirectory "assets\game\monster-paper-lantern-v3.webp"))))"
$MonsterLotusFlameData = "data:image/webp;base64,$([Convert]::ToBase64String([IO.File]::ReadAllBytes((Join-Path $AppDirectory "assets\game\monster-lotus-flame-v3.webp"))))"
$MonsterInkKingData = "data:image/webp;base64,$([Convert]::ToBase64String([IO.File]::ReadAllBytes((Join-Path $AppDirectory "assets\game\monster-ink-king-v3.webp"))))"
...
$ArcadeScript = $ArcadeScript.Replace('./assets/game/monster-paper-lantern-v3.webp', $MonsterPaperLanternData)
$ArcadeScript = $ArcadeScript.Replace('./assets/game/monster-lotus-flame-v3.webp', $MonsterLotusFlameData)
$ArcadeScript = $ArcadeScript.Replace('./assets/game/monster-ink-king-v3.webp', $MonsterInkKingData)
